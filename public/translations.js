...
var T = {
  ar: {
    ...
    airdropWatchAdsTask:'شاهد إعلانات',
    airdropWatchAdsLabel:'شاهد {n} إعلان',
    airdropTaskTimeLeft:'متبقي',
    airdropPointsUnit:'نقطة',
    airdropWatchAdsFaqLabel:'مهمة الإعلانات',
    airdropWatchAdsFaqSub:'مراحل مكتملة',
    withdrawMinLabel:'الحد الأدنى',
    withdrawFeeLabel:'رسوم الشبكة',
    withdrawAmountLabel:'المبلغ (REC)',
    withdrawSubmit:'تأكيد السحب',
    withdrawYouReceive:'ستحصل على',
    withdrawSuccess:'أُرسل لمحفظتك!',
    withdrawErrorWallet:'ربط محفظتك أولاً',
    withdrawErrorBalance:'الرصيد غير كافٍ',
    withdrawErrorLimit:'تجاوزت الحد اليومي',
    withdrawErrorUser:'خطأ في المستخدم',
    vipLevelsTitle:'مستويات VIP',
    vipMonthLabel:'شهر',
    vipAvailable:'متاح',
    vipFeat1:'٣ صناديق يومية (Common, Rare, Epic)',
    vipFeat2:'فرصة الحصول على بطاقة Epic النادرة (١٪)',
    vipFeat3:'×١.٥ سرعة تعدين REC',
    vipFeat4:'شحن طاقة ٦ مرات يومياً',
    vipFeat5:'سحب: ٥٠,٠٠٠ – ١٠٠,٠٠٠ REC/يوم',
    vipFeat6:'تلميح بطاقة واحدة من الكومبو',
    vipFeat7:'+٥٠ REC مكافأة ترحيبية فورية',
    vipFeat8:'شارة VIP ذهبية بالليدربورد',
    vipIIDesc:'كل مميزات VIP I + مميزات حصرية إضافية',
    vipIIIDesc:'المستوى الأعلى — مميزات لا مثيل لها',
    vipWelcomeToast:'+٥٠ REC مكافأة ترحيبية!',
    vipBoxError:'خطأ في فتح الصندوق',
    vipConnectWalletFirst:'ربط محفظتك أولاً!',
    vipOpeningWallet:'جاري فتح محفظتك...',
    vipVerifyingPayment:'جاري التحقق من الدفع...',
    vipActivatedSuccess:'تم تفعيل VIP بنجاح!',
    vipActivatedOK:'تم التفعيل بنجاح!',
    vipVerifyFailed:'فشل التحقق',
    vipServerError:'خطأ في السيرفر',
    vipPaymentCancelled:'تم إلغاء الدفع',
    vipPaymentError:'خطأ في الدفع',
    vipBoostAlreadyActive:'البوست مفعّل اليوم مسبقاً',
    vipBoostActivatedToast:'تم تفعيل ×١.٥ تعدين REC!',
    vipEnergyUsed:'تمت تعبئة الطاقة!',
    vipEnergyLeft:'فرص متبقية',
    lbAutoRefresh:'تحديث تلقائي كل ٥ دق',
    lbRefreshNow:'تحديث',
    linkCopied:'تم نسخ الرابط!',
    inviteShareText:'انضم معي على REC Mining واكسب!'
  },
  ...
  en: {
    ...
    airdropWatchAdsTask:'Watch Ads',
    airdropWatchAdsLabel:'Watch {n} ads',
    airdropTaskTimeLeft:'left',
    airdropPointsUnit:'pts',
    airdropWatchAdsFaqLabel:'Watch Ads Task',
    airdropWatchAdsFaqSub:'tiers',
    withdrawMinLabel:'Minimum',
    withdrawFeeLabel:'Network fee',
    withdrawAmountLabel:'Amount (REC)',
    withdrawSubmit:'Confirm Withdrawal',
    withdrawYouReceive:'You receive',
    withdrawSuccess:'sent to your wallet!',
    withdrawErrorWallet:'Connect wallet first',
    withdrawErrorBalance:'Insufficient balance',
    withdrawErrorLimit:'Daily limit reached',
    withdrawErrorUser:'User error',
    vipLevelsTitle:'VIP Levels',
    vipMonthLabel:'month',
    vipAvailable:'Available',
    vipFeat1:'3 daily boxes (Common, Rare, Epic)',
    vipFeat2:'Rare Epic card chance (1%)',
    vipFeat3:'x1.5 REC mining speed',
    vipFeat4:'6x energy recharge daily',
    vipFeat5:'Withdraw: 50,000 - 100,000 REC/day',
    vipFeat6:'Daily combo hint (1 card)',
    vipFeat7:'+50 REC instant welcome bonus',
    vipFeat8:'Gold VIP badge on leaderboard',
    vipIIDesc:'All VIP I benefits + exclusive extras',
    vipIIIDesc:'The highest tier - unmatched benefits',
    vipWelcomeToast:'+50 REC Welcome Bonus!',
    vipBoxError:'Error opening box',
    vipConnectWalletFirst:'Connect your wallet first!',
    vipOpeningWallet:'Opening your wallet...',
    vipVerifyingPayment:'Verifying payment...',
    vipActivatedSuccess:'VIP activated successfully!',
    vipActivatedOK:'activated successfully!',
    vipVerifyFailed:'Verification failed',
    vipServerError:'Server error',
    vipPaymentCancelled:'Payment cancelled',
    vipPaymentError:'Payment error',
    vipBoostAlreadyActive:'Boost already active today',
    vipBoostActivatedToast:'x1.5 REC mining activated!',
    vipEnergyUsed:'Energy refilled!',
    vipEnergyLeft:'remaining',
    lbAutoRefresh:'Auto-updates every 5 min',
    lbRefreshNow:'Refresh',
    linkCopied:'Link copied!',
    inviteShareText:'Join me on REC Mining and start earning!'
  },
  ...
  ru: {
    ...
    airdropWatchAdsTask:'Смотреть рекламу',
    airdropWatchAdsLabel:'Смотреть {n} реклам',
    airdropTaskTimeLeft:'осталось',
    airdropPointsUnit:'очков',
    airdropWatchAdsFaqLabel:'Задание Реклама',
    airdropWatchAdsFaqSub:'уровней',
    withdrawMinLabel:'Минимум',
    withdrawFeeLabel:'Комиссия сети',
    withdrawAmountLabel:'Сумма (REC)',
    withdrawSubmit:'Подтвердить вывод',
    withdrawYouReceive:'Получите',
    withdrawSuccess:'отправлено на кошелёк!',
    withdrawErrorWallet:'Подключи кошелёк',
    withdrawErrorBalance:'Недостаточно средств',
    withdrawErrorLimit:'Дневной лимит',
    withdrawErrorUser:'Ошибка пользователя',
    vipLevelsTitle:'Уровни VIP',
    vipMonthLabel:'мес',
    vipAvailable:'Доступно',
    vipFeat1:'3 ящика в день (Common, Rare, Epic)',
    vipFeat2:'Шанс Epic карты (1%)',
    vipFeat3:'x1.5 скорость майнинга',
    vipFeat4:'6x зарядка энергии в день',
    vipFeat5:'Вывод: 50000 – 100000 REC/день',
    vipFeat6:'Подсказка карты комбо',
    vipFeat7:'+50 REC приветственный бонус',
    vipFeat8:'Золотой VIP значок',
    vipIIDesc:'Все бонусы VIP I + эксклюзивные',
    vipIIIDesc:'Высший уровень — непревзойдённые бонусы',
    vipWelcomeToast:'+50 REC Бонус!',
    vipBoxError:'Ошибка открытия ящика',
    vipConnectWalletFirst:'Подключи кошелёк!',
    vipOpeningWallet:'Открываем кошелёк...',
    vipVerifyingPayment:'Проверяем оплату...',
    vipActivatedSuccess:'VIP активирован!',
    vipActivatedOK:'успешно активирован!',
    vipVerifyFailed:'Ошибка проверки',
    vipServerError:'Ошибка сервера',
    vipPaymentCancelled:'Оплата отменена',
    vipPaymentError:'Ошибка оплаты',
    vipBoostAlreadyActive:'Буст уже активен',
    vipBoostActivatedToast:'x1.5 майнинг активирован!',
    vipEnergyUsed:'Энергия заряжена!',
    vipEnergyLeft:'осталось',
    lbAutoRefresh:'Обновление каждые 5 мин',
    lbRefreshNow:'Обновить',
    linkCopied:'Ссылка скопирована!',
    inviteShareText:'Присоединяйся к REC Mining!'
  },
  ...
  uk: {
    ...
    airdropWatchAdsTask:'Дивитись рекламу',
    airdropWatchAdsLabel:'Переглянути {n} реклам',
    airdropTaskTimeLeft:'залишилось',
    airdropPointsUnit:'очок',
    airdropWatchAdsFaqLabel:'Завдання Реклама',
    airdropWatchAdsFaqSub:'рівнів',
    withdrawMinLabel:'Мінімум',
    withdrawFeeLabel:'Комісія мережі',
    withdrawAmountLabel:'Сума (REC)',
    withdrawSubmit:'Підтвердити виведення',
    withdrawYouReceive:'Отримаєте',
    withdrawSuccess:'надіслано на гаманець!',
    withdrawErrorWallet:'Підключи гаманець',
    withdrawErrorBalance:'Недостатньо коштів',
    withdrawErrorLimit:'Денний ліміт',
    withdrawErrorUser:'Помилка користувача',
    vipLevelsTitle:'Рівні VIP',
    vipMonthLabel:'міс',
    vipAvailable:'Доступно',
    vipFeat1:'3 скрині в день (Common, Rare, Epic)',
    vipFeat2:'Шанс Epic карти (1%)',
    vipFeat3:'x1.5 швидкість майнінгу',
    vipFeat4:'6x зарядка енергії на день',
    vipFeat5:'Виведення: 50000 – 100000 REC/день',
    vipFeat6:'Підказка карти комбо',
    vipFeat7:'+50 REC вітальний бонус',
    vipFeat8:'Золотий VIP значок',
    vipIIDesc:'Всі бонуси VIP I + ексклюзивні',
    vipIIIDesc:'Найвищий рівень — неперевершені бонуси',
    vipWelcomeToast:'+50 REC Бонус!',
    vipBoxError:'Помилка скрині',
    vipConnectWalletFirst:'Підключи гаманець!',
    vipOpeningWallet:'Відкриваємо гаманець...',
    vipVerifyingPayment:'Перевіряємо оплату...',
    vipActivatedSuccess:'VIP активовано!',
    vipActivatedOK:'успішно активовано!',
    vipVerifyFailed:'Помилка перевірки',
    vipServerError:'Помилка сервера',
    vipPaymentCancelled:'Оплату скасовано',
    vipPaymentError:'Помилка оплати',
    vipBoostAlreadyActive:'Буст вже активний',
    vipBoostActivatedToast:'x1.5 майнінг активовано!',
    vipEnergyUsed:'Енергія заряджена!',
    vipEnergyLeft:'залишилось',
    lbAutoRefresh:'Оновлення кожні 5 хв',
    lbRefreshNow:'Оновити',
    linkCopied:'Посилання скопійовано!',
    inviteShareText:'Приєднуйся до REC Mining!'
  },
  ...
  pt: {
    ...
    airdropWatchAdsTask:'Assistir Anuncios',
    airdropWatchAdsLabel:'Assistir {n} anuncios',
    airdropTaskTimeLeft:'restante',
    airdropPointsUnit:'pts',
    airdropWatchAdsFaqLabel:'Tarefa Anuncios',
    airdropWatchAdsFaqSub:'niveis',
    withdrawMinLabel:'Minimo',
    withdrawFeeLabel:'Taxa de rede',
    withdrawAmountLabel:'Valor (REC)',
    withdrawSubmit:'Confirmar Saque',
    withdrawYouReceive:'Voce recebe',
    withdrawSuccess:'enviado para sua carteira!',
    withdrawErrorWallet:'Conecte a carteira',
    withdrawErrorBalance:'Saldo insuficiente',
    withdrawErrorLimit:'Limite diario',
    withdrawErrorUser:'Erro de usuario',
    vipLevelsTitle:'Niveis VIP',
    vipMonthLabel:'mes',
    vipAvailable:'Disponivel',
    vipFeat1:'3 caixas diarias (Common, Rare, Epic)',
    vipFeat2:'Chance de carta Epic (1%)',
    vipFeat3:'x1.5 velocidade de mineracao',
    vipFeat4:'6x recarga de energia diaria',
    vipFeat5:'Saque: 50000 – 100000 REC/dia',
    vipFeat6:'Dica de carta combo',
    vipFeat7:'+50 REC bonus de boas-vindas',
    vipFeat8:'Emblema VIP dourado',
    vipIIDesc:'Todos os beneficios VIP I + extras',
    vipIIIDesc:'O nivel mais alto — beneficios incomparaveis',
    vipWelcomeToast:'+50 REC Bonus!',
    vipBoxError:'Erro ao abrir caixa',
    vipConnectWalletFirst:'Conecte sua carteira!',
    vipOpeningWallet:'Abrindo carteira...',
    vipVerifyingPayment:'Verificando pagamento...',
    vipActivatedSuccess:'VIP ativado!',
    vipActivatedOK:'ativado com sucesso!',
    vipVerifyFailed:'Falha na verificacao',
    vipServerError:'Erro no servidor',
    vipPaymentCancelled:'Pagamento cancelado',
    vipPaymentError:'Erro no pagamento',
    vipBoostAlreadyActive:'Boost ja ativo hoje',
    vipBoostActivatedToast:'x1.5 mineracao ativada!',
    vipEnergyUsed:'Energia recarregada!',
    vipEnergyLeft:'restante',
    lbAutoRefresh:'Atualiza a cada 5 min',
    lbRefreshNow:'Atualizar',
    linkCopied:'Link copiado!',
    inviteShareText:'Junte-se ao REC Mining!'
  },
  ...
  es: {
    ...
    airdropWatchAdsTask:'Ver Anuncios',
    airdropWatchAdsLabel:'Ver {n} anuncios',
    airdropTaskTimeLeft:'restante',
    airdropPointsUnit:'pts',
    airdropWatchAdsFaqLabel:'Tarea Anuncios',
    airdropWatchAdsFaqSub:'niveles',
    withdrawMinLabel:'Minimo',
    withdrawFeeLabel:'Comision de red',
    withdrawAmountLabel:'Cantidad (REC)',
    withdrawSubmit:'Confirmar Retiro',
    withdrawYouReceive:'Recibiras',
    withdrawSuccess:'enviado a tu billetera!',
    withdrawErrorWallet:'Conecta tu billetera',
    withdrawErrorBalance:'Saldo insuficiente',
    withdrawErrorLimit:'Limite diario',
    withdrawErrorUser:'Error de usuario',
    vipLevelsTitle:'Niveles VIP',
    vipMonthLabel:'mes',
    vipAvailable:'Disponible',
    vipFeat1:'3 cajas diarias (Common, Rare, Epic)',
    vipFeat2:'Oportunidad de carta Epic (1%)',
    vipFeat3:'x1.5 velocidad de mineria',
    vipFeat4:'6x recarga de energia diaria',
    vipFeat5:'Retiro: 50000 – 100000 REC/dia',
    vipFeat6:'Pista de carta combo',
    vipFeat7:'+50 REC bono de bienvenida',
    vipFeat8:'Insignia VIP dorada',
    vipIIDesc:'Todos los beneficios VIP I + exclusivos',
    vipIIIDesc:'El nivel mas alto — sin igual',
    vipWelcomeToast:'+50 REC Bono!',
    vipBoxError:'Error al abrir caja',
    vipConnectWalletFirst:'Conecta tu billetera!',
    vipOpeningWallet:'Abriendo billetera...',
    vipVerifyingPayment:'Verificando pago...',
    vipActivatedSuccess:'VIP activado!',
    vipActivatedOK:'activado con exito!',
    vipVerifyFailed:'Error de verificacion',
    vipServerError:'Error del servidor',
    vipPaymentCancelled:'Pago cancelado',
    vipPaymentError:'Error de pago',
    vipBoostAlreadyActive:'Boost ya activo hoy',
    vipBoostActivatedToast:'x1.5 mineria activada!',
    vipEnergyUsed:'Energia recargada!',
    vipEnergyLeft:'restante',
    lbAutoRefresh:'Actualiza cada 5 min',
    lbRefreshNow:'Actualizar',
    linkCopied:'Enlace copiado!',
    inviteShareText:'Unete a REC Mining!'
  },
  ...
  tr: {
    ...
    airdropWatchAdsTask:'Reklam Izle',
    airdropWatchAdsLabel:'{n} reklam izle',
    airdropTaskTimeLeft:'kaldi',
    airdropPointsUnit:'puan',
    airdropWatchAdsFaqLabel:'Reklam Gorevi',
    airdropWatchAdsFaqSub:'seviye',
    withdrawMinLabel:'Minimum',
    withdrawFeeLabel:'Ag ucreti',
    withdrawAmountLabel:'Miktar (REC)',
    withdrawSubmit:'Cekimi Onayla',
    withdrawYouReceive:'Alacaksiniz',
    withdrawSuccess:'cuzdaniniza gonderildi!',
    withdrawErrorWallet:'Cuzdani bagla',
    withdrawErrorBalance:'Yetersiz bakiye',
    withdrawErrorLimit:'Gunluk limit',
    withdrawErrorUser:'Kullanici hatasi',
    vipLevelsTitle:'VIP Seviyeleri',
    vipMonthLabel:'ay',
    vipAvailable:'Mevcut',
    vipFeat1:'3 gunluk kutu (Common, Rare, Epic)',
    vipFeat2:'Nadir Epic kart sansi (%1)',
    vipFeat3:'x1.5 madencilik hizi',
    vipFeat4:'Gunluk 6x enerji sarji',
    vipFeat5:'Cekim: 50000 – 100000 REC/gun',
    vipFeat6:'Gunluk kombo ipucu',
    vipFeat7:'+50 REC hos geldin bonusu',
    vipFeat8:'Altin VIP rozeti',
    vipIIDesc:'Tum VIP I avantajlari + ozel ekstralar',
    vipIIIDesc:'En yuksek seviye — essiz avantajlar',
    vipWelcomeToast:'+50 REC Bonus!',
    vipBoxError:'Kutu acma hatasi',
    vipConnectWalletFirst:'Cuzdani bagla!',
    vipOpeningWallet:'Cuzdan aciliyor...',
    vipVerifyingPayment:'Odeme dogrulanıyor...',
    vipActivatedSuccess:'VIP aktif!',
    vipActivatedOK:'basariyla aktif!',
    vipVerifyFailed:'Dogrulama hatasi',
    vipServerError:'Sunucu hatasi',
    vipPaymentCancelled:'Odeme iptal',
    vipPaymentError:'Odeme hatasi',
    vipBoostAlreadyActive:'Boost bugun aktif',
    vipBoostActivatedToast:'x1.5 madencilik aktif!',
    vipEnergyUsed:'Enerji dolduruldu!',
    vipEnergyLeft:'kaldi',
    lbAutoRefresh:'Her 5 dakikada guncellenir',
    lbRefreshNow:'Yenile',
    linkCopied:'Baglanti kopyalandi!',
    inviteShareText:'REC Mining katil!'
  },
  ...
  vi: {
    ...
    airdropWatchAdsTask:'Xem Quang Cao',
    airdropWatchAdsLabel:'Xem {n} quang cao',
    airdropTaskTimeLeft:'con lai',
    airdropPointsUnit:'diem',
    airdropWatchAdsFaqLabel:'Nhiem Vu Quang Cao',
    airdropWatchAdsFaqSub:'cap do',
    withdrawMinLabel:'Toi thieu',
    withdrawFeeLabel:'Phi mang',
    withdrawAmountLabel:'So luong (REC)',
    withdrawSubmit:'Xac Nhan Rut',
    withdrawYouReceive:'Ban nhan',
    withdrawSuccess:'da gui den vi!',
    withdrawErrorWallet:'Ket noi vi truoc',
    withdrawErrorBalance:'So du khong du',
    withdrawErrorLimit:'Dat gioi han ngay',
    withdrawErrorUser:'Loi nguoi dung',
    vipLevelsTitle:'Cap Do VIP',
    vipMonthLabel:'thang',
    vipAvailable:'Kha dung',
    vipFeat1:'3 hop hang ngay (Common, Rare, Epic)',
    vipFeat2:'Co hoi the Epic (1%)',
    vipFeat3:'x1.5 toc do dao',
    vipFeat4:'Sac nang luong 6 lan/ngay',
    vipFeat5:'Rut: 50000 – 100000 REC/ngay',
    vipFeat6:'Goi y the combo',
    vipFeat7:'+50 REC thuong chao mung',
    vipFeat8:'Huy hieu VIP vang',
    vipIIDesc:'Tat ca loi ich VIP I + dac quyen',
    vipIIIDesc:'Cap cao nhat — loi ich vo song',
    vipWelcomeToast:'+50 REC Thuong!',
    vipBoxError:'Loi mo hop',
    vipConnectWalletFirst:'Ket noi vi truoc!',
    vipOpeningWallet:'Dang mo vi...',
    vipVerifyingPayment:'Dang xac minh...',
    vipActivatedSuccess:'VIP da kich hoat!',
    vipActivatedOK:'kich hoat thanh cong!',
    vipVerifyFailed:'Xac minh that bai',
    vipServerError:'Loi may chu',
    vipPaymentCancelled:'Da huy thanh toan',
    vipPaymentError:'Loi thanh toan',
    vipBoostAlreadyActive:'Boost da hoat dong',
    vipBoostActivatedToast:'x1.5 dao da kich hoat!',
    vipEnergyUsed:'Da nap nang luong!',
    vipEnergyLeft:'con lai',
    lbAutoRefresh:'Tu dong cap nhat 5 phut',
    lbRefreshNow:'Lam moi',
    linkCopied:'Da sao chep lien ket!',
    inviteShareText:'Tham gia REC Mining!'
  },
  ...
  zh: {
    ...
    adsWaiting:'尚未开始',
    airdropWatchAdsTask:'观看广告',
    airdropWatchAdsLabel:'观看 {n} 个广告',
    airdropTaskTimeLeft:'剩余',
    airdropPointsUnit:'分',
    airdropWatchAdsFaqLabel:'观看广告任务',
    airdropWatchAdsFaqSub:'等级',
    withdrawMinLabel:'最低金额',
    withdrawFeeLabel:'网络费用',
    withdrawAmountLabel:'金额 (REC)',
    withdrawSubmit:'确认提现',
    withdrawYouReceive:'您将收到',
    withdrawSuccess:'已发送到您的钱包！',
    withdrawErrorWallet:'请先连接钱包',
    withdrawErrorBalance:'余额不足',
    withdrawErrorLimit:'已达每日限额',
    withdrawErrorUser:'用户错误',
    vipLevelsTitle:'VIP等级',
    vipMonthLabel:'月',
    vipAvailable:'可用',
    vipFeat1:'每日3个宝箱 (Common, Rare, Epic)',
    vipFeat2:'稀有Epic卡片概率 (1%)',
    vipFeat3:'x1.5 挖矿速度',
    vipFeat4:'每日6次能量充电',
    vipFeat5:'提现: 50000 – 100000 REC/天',
    vipFeat6:'每日组合提示',
    vipFeat7:'+50 REC 欢迎奖励',
    vipFeat8:'金色VIP徽章',
    vipIIDesc:'所有VIP I权益 + 专属额外权益',
    vipIIIDesc:'最高等级 — 无与伦比的权益',
    vipWelcomeToast:'+50 REC 欢迎奖励！',
    vipBoxError:'打开宝箱出错',
    vipConnectWalletFirst:'请先连接钱包！',
    vipOpeningWallet:'正在打开钱包...',
    vipVerifyingPayment:'正在验证付款...',
    vipActivatedSuccess:'VIP 已激活！',
    vipActivatedOK:'激活成功！',
    vipVerifyFailed:'验证失败',
    vipServerError:'服务器错误',
    vipPaymentCancelled:'付款已取消',
    vipPaymentError:'付款错误',
    vipBoostAlreadyActive:'今日加速已激活',
    vipBoostActivatedToast:'x1.5挖矿已激活！',
    vipEnergyUsed:'能量已充满！',
    vipEnergyLeft:'剩余',
    lbAutoRefresh:'每5分钟自动更新',
    lbRefreshNow:'刷新',
    linkCopied:'链接已复制！',
    inviteShareText:'加入REC Mining！'
  },
    vipBoxOpening:'🎁 开启中...',
    adsTitle:'📺 广告', adsWatchEarn:'观看赚取', adsWatchSub:'观看广告免费赚取REC',
    adsRewardLabel:'每次广告奖励', adsWatchedToday:'今日观看次数',
