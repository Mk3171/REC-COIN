...
var T = {
  ar: {
    ...
    vipSoonLock:'قريباً 🔒', vipLevelsTitle:'مستويات VIP', vipMonthLabel:'شهر', vipAvailable:'متاح',
    vipFeat1:'٣ صناديق يومية (Common, Rare, Epic)', vipFeat2:'فرصة الحصول على بطاقة Epic النادرة (١٪)',
    vipFeat3:'×١.٥ سرعة تعدين REC', vipFeat4:'شحن طاقة ٦ مرات يومياً',
    vipFeat5:'سحب: ٥٠٬٠٠٠ – ١٠٠٬٠٠٠ REC/يوم', vipFeat6:'تلميح بطاقة واحدة من الكومبو',
    vipFeat7:'+٥٠ REC مكافأة ترحيبية فورية', vipFeat8:'شارة VIP ذهبية بالليدربورد',
    vipIIDesc:'كل مميزات VIP I + مميزات حصرية إضافية', vipIIIDesc:'المستوى الأعلى — مميزات لا مثيل لها',
    vipWelcomeToast:'+٥٠ REC مكافأة ترحيبية!', vipBoxError:'خطأ في فتح الصندوق',
    vipConnectWalletFirst:'ربط محفظتك أولاً!', vipOpeningWallet:'جاري فتح محفظتك...',
    vipVerifyingPayment:'جاري التحقق من الدفع...', vipActivatedSuccess:'تم تفعيل VIP I بنجاح!',
    vipActivatedOK:'تم تفعيله بنجاح!', vipVerifyFailed:'فشل التحقق', vipServerError:'خطأ في السيرفر',
    vipPaymentCancelled:'تم إلغاء الدفع', vipPaymentError:'خطأ في الدفع',
    vipBoostAlreadyActive:'البوست مفعّل اليوم مسبقاً', vipBoostActivatedToast:'تم تفعيل ×١.٥ تعدين REC!',
  ...
  en: {
    ...
    vipWithdrawDesc:'Up to 20,000 REC / day', vipSoonLock:'Soon 🔒', vipLevelsTitle:'VIP Levels', vipMonthLabel:'month', vipAvailable:'Available',
    vipFeat1:'3 daily boxes (Common, Rare, Epic)', vipFeat2:'Rare Epic card chance (1%)',
    vipFeat3:'×1.5 REC mining speed', vipFeat4:'6x energy recharge daily',
    vipFeat5:'Withdraw: 50,000 – 100,000 REC/day', vipFeat6:'Daily combo hint (1 card)',
    ...
    vipVerifyingPayment:'Verifying payment...', vipActivatedSuccess:'VIP I activated successfully!',
    vipActivatedOK:'activated successfully!', vipVerifyFailed:'Verification failed',
    vipServerError:'Server error', vipPaymentCancelled:'Payment cancelled', vipPaymentError:'Payment error',
    vipBoostAlreadyActive:'Boost already active today', vipBoostActivatedToast:'×1.5 REC mining activated!',
  ...
  ru: {
    ...
    vipWithdrawDesc:'Вывод: 50,000 – 100,000 REC/день', vipSoonLock:'Скоро 🔒',
    vipFeat1:'3 ежедневных ящика (Common, Rare, Epic)', vipFeat2:'Шанс Epic карты (1%)',
    vipFeat3:'×1.5 скорость майнинга', vipFeat4:'6x зарядка энергии в день',
    vipFeat5:'Вывод: 50,000 – 100,000 REC/день', vipFeat6:'Подсказка карты комбо',
    ...
    vipWelcomeToast:'+50 REC Приветственный Бонус!', vipBoxError:'Ошибка открытия ящика',
    vipConnectWalletFirst:'Подключи кошелёк!', vipOpeningWallet:'Открываем кошелёк...',
    vipVerifyingPayment:'Проверяем оплату...', vipActivatedSuccess:'VIP I активирован!',
    vipActivatedOK:'успешно активирован!', vipVerifyFailed:'Ошибка проверки',
    vipServerError:'Ошибка сервера', vipPaymentCancelled:'Оплата отменена', vipPaymentError:'Ошибка оплаты',
    vipBoostAlreadyActive:'Буст уже активен', vipBoostActivatedToast:'×1.5 майнинг активирован!',
  ...
  uk: {
    ...
    vipWithdrawDesc:'Виведення: 50,000 – 100,000 REC/день', vipSoonLock:'Скоро 🔒',
    vipFeat1:'3 щоденні скрині (Common, Rare, Epic)', vipFeat2:'Шанс Epic карти (1%)',
    vipFeat3:'×1.5 швидкість майнінгу', vipFeat4:'6x зарядка енергії на день',
    vipFeat5:'Виведення: 50,000 – 100,000 REC/день', vipFeat6:'Підказка карти комбо',
    ...
    vipWelcomeToast:'+50 REC Вітальний Бонус!', vipBoxError:'Помилка відкриття скрині',
    vipConnectWalletFirst:'Підключи гаманець!', vipOpeningWallet:'Відкриваємо гаманець...',
    vipVerifyingPayment:'Перевіряємо оплату...', vipActivatedSuccess:'VIP I активовано!',
    vipActivatedOK:'успішно активовано!', vipVerifyFailed:'Помилка перевірки',
    vipServerError:'Помилка сервера', vipPaymentCancelled:'Оплату скасовано', vipPaymentError:'Помилка оплати',
    vipBoostAlreadyActive:'Буст вже активний', vipBoostActivatedToast:'×1.5 майнінг активовано!',
  ...
  pt: {
    ...
    vipWithdrawDesc:'Até 20.000 REC / dia', vipSoonLock:'Em breve 🔒', vipLevelsTitle:'Níveis VIP', vipMonthLabel:'mês', vipAvailable:'Disponível',
    vipFeat1:'3 caixas diárias (Common, Rare, Epic)', vipFeat2:'Chance de carta Epic (1%)',
    vipFeat3:'×1.5 velocidade de mineração', vipFeat4:'6x recarga de energia diária',
    vipFeat5:'Saque: 50.000 – 100.000 REC/dia', vipFeat6:'Dica de carta combo',
    vipFeat7:'+50 REC bônus de boas-vindas', vipFeat8:'Emblema VIP dourado',
    vipIIDesc:'Todos os benefícios VIP I + extras', vipIIIDesc:'O nível mais alto — benefícios incomparáveis',
    vipWelcomeToast:'+50 REC Bônus!', vipBoxError:'Erro ao abrir caixa',
    vipConnectWalletFirst:'Conecte sua carteira primeiro!', vipOpeningWallet:'Abrindo carteira...',
    vipVerifyingPayment:'Verificando pagamento...', vipActivatedSuccess:'VIP I ativado com sucesso!',
    vipActivatedOK:'ativado com sucesso!', vipVerifyFailed:'Falha na verificação',
    vipServerError:'Erro no servidor', vipPaymentCancelled:'Pagamento cancelado', vipPaymentError:'Erro no pagamento',
    vipBoostAlreadyActive:'Boost já ativo hoje', vipBoostActivatedToast:'×1.5 mineração ativada!',
  ...
  es: {
    ...
    vipWithdrawDesc:'Hasta 20,000 REC / día', vipSoonLock:'Próximamente 🔒', vipLevelsTitle:'Niveles VIP', vipMonthLabel:'mes', vipAvailable:'Disponible',
    vipFeat1:'3 cajas diarias (Common, Rare, Epic)', vipFeat2:'Oportunidad de carta Epic (1%)',
    vipFeat3:'×1.5 velocidad de minería', vipFeat4:'6x recarga de energía diaria',
    vipFeat5:'Retiro: 50,000 – 100,000 REC/día', vipFeat6:'Pista de carta combo',
    vipFeat7:'+50 REC bono de bienvenida', vipFeat8:'Insignia VIP dorada',
    vipIIDesc:'Todos los beneficios VIP I + exclusivos', vipIIIDesc:'El nivel más alto — beneficios sin igual',
    vipWelcomeToast:'+50 REC ¡Bono!', vipBoxError:'Error al abrir caja',
    vipConnectWalletFirst:'¡Conecta tu billetera primero!', vipOpeningWallet:'Abriendo billetera...',
    vipVerifyingPayment:'Verificando pago...', vipActivatedSuccess:'¡VIP I activado!',
    vipActivatedOK:'activado con éxito!', vipVerifyFailed:'Error de verificación',
    vipServerError:'Error del servidor', vipPaymentCancelled:'Pago cancelado', vipPaymentError:'Error de pago',
    vipBoostAlreadyActive:'Boost ya activo hoy', vipBoostActivatedToast:'¡×1.5 minería activada!',
    vipEnergyUsed:'¡Energía recargada!', vipEnergyLeft:'restante',
  ...
  tr: {
    ...
    vipWithdrawDesc:'20.000 REC kadar / gün', vipSoonLock:'Yakında 🔒', vipLevelsTitle:'VIP Seviyeleri', vipMonthLabel:'ay', vipAvailable:'Mevcut',
    vipFeat1:'3 günlük kutu (Common, Rare, Epic)', vipFeat2:'Nadir Epic kart şansı (%1)',
    vipFeat3:'×1.5 madencilik hızı', vipFeat4:'Günlük 6x enerji şarjı',
    vipFeat5:'Çekim: 50.000 – 100.000 REC/gün', vipFeat6:'Günlük kombo ipucu',
    vipFeat7:'+50 REC hoş geldin bonusu', vipFeat8:'Altın VIP rozeti',
    vipIIDesc:'Tüm VIP I avantajları + özel ekstralar', vipIIIDesc:'En yüksek seviye — eşsiz avantajlar',
    vipWelcomeToast:'+50 REC Hoş Geldin!', vipBoxError:'Kutu açma hatası',
    vipConnectWalletFirst:'Önce cüzdanını bağla!', vipOpeningWallet:'Cüzdan açılıyor...',
    vipVerifyingPayment:'Ödeme doğrulanıyor...', vipActivatedSuccess:'VIP I etkinleştirildi!',
    vipActivatedOK:'başarıyla etkinleştirildi!', vipVerifyFailed:'Doğrulama hatası',
    vipServerError:'Sunucu hatası', vipPaymentCancelled:'Ödeme iptal edildi', vipPaymentError:'Ödeme hatası',
    vipBoostAlreadyActive:'Boost bugün zaten aktif', vipBoostActivatedToast:'×1.5 madencilik aktif!',
    vipEnergyUsed:'Enerji dolduruldu!', vipEnergyLeft:'kaldı',
  ...
  vi: {
    ...
    vipWithdrawDesc:'Đến 20,000 REC / ngày', vipSoonLock:'Sắp có 🔒', vipLevelsTitle:'Cấp Độ VIP', vipMonthLabel:'tháng', vipAvailable:'Khả dụng',
    vipFeat1:'3 hộp hàng ngày (Common, Rare, Epic)', vipFeat2:'Cơ hội thẻ Epic (1%)',
    vipFeat3:'×1.5 tốc độ đào', vipFeat4:'Sạc năng lượng 6 lần/ngày',
    vipFeat5:'Rút: 50.000 – 100.000 REC/ngày', vipFeat6:'Gợi ý thẻ combo',
    vipFeat7:'+50 REC thưởng chào mừng', vipFeat8:'Huy hiệu VIP vàng',
    vipIIDesc:'Tất cả lợi ích VIP I + đặc quyền', vipIIIDesc:'Cấp cao nhất — lợi ích vô song',
    vipWelcomeToast:'+50 REC Thưởng!', vipBoxError:'Lỗi mở hộp',
    vipConnectWalletFirst:'Kết nối ví trước!', vipOpeningWallet:'Đang mở ví...',
    vipVerifyingPayment:'Đang xác minh...', vipActivatedSuccess:'VIP I đã kích hoạt!',
    vipActivatedOK:'đã kích hoạt thành công!', vipVerifyFailed:'Xác minh thất bại',
    vipServerError:'Lỗi máy chủ', vipPaymentCancelled:'Đã hủy thanh toán', vipPaymentError:'Lỗi thanh toán',
    vipBoostAlreadyActive:'Boost đã hoạt động hôm nay', vipBoostActivatedToast:'×1.5 đào đã kích hoạt!',
    vipEnergyUsed:'Đã nạp năng lượng!', vipEnergyLeft:'còn lại',
  ...
  zh: {
    ...
    vipWithdrawDesc:'每天最多 20,000 REC', vipSoonLock:'即将推出 🔒', vipLevelsTitle:'VIP等级', vipMonthLabel:'月', vipAvailable:'可用',
    vipFeat1:'每日3个宝箱 (Common, Rare, Epic)', vipFeat2:'稀有Epic卡片概率 (1%)',
    vipFeat3:'×1.5 挖矿速度', vipFeat4:'每日6次能量充电',
    vipFeat5:'提现: 50,000 – 100,000 REC/天', vipFeat6:'每日组合提示',
    vipFeat7:'+50 REC 欢迎奖励', vipFeat8:'金色VIP徽章',
    vipIIDesc:'所有VIP I权益 + 专属额外权益', vipIIIDesc:'最高等级 — 无与伦比的权益',
    vipWelcomeToast:'+50 REC 欢迎奖励！', vipBoxError:'打开宝箱出错',
    vipConnectWalletFirst:'请先连接钱包！', vipOpeningWallet:'正在打开钱包...',
    vipVerifyingPayment:'正在验证付款...', vipActivatedSuccess:'VIP I 已激活！',
    vipActivatedOK:'激活成功！', vipVerifyFailed:'验证失败',
    vipServerError:'服务器错误', vipPaymentCancelled:'付款已取消', vipPaymentError:'付款错误',
    vipBoostAlreadyActive:'今日加速已激活', vipBoostActivatedToast:'×1.5挖矿已激活！',
