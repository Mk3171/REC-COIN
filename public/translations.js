...
var T = {
  ar: {
    ...
    vipBoxClose:'إغلاق', vipBoxYouGot:'حصلت على', vipBoxGreat:'🎉 رائع!', vipInfoII:'كل مميزات VIP I + مميزات حصرية إضافية', vipInfoIII:'المستوى الأعلى — مميزات لا مثيل لها', vipExclusiveMembership:'عضوية حصرية', vipComingSoon:'سيُفتح هذا المستوى قريباً', locked:'مقفول',
    // Toasts
  ...
  en: {
    ...
    vipBoxClose:'Close', vipBoxYouGot:'You got', vipBoxGreat:'🎉 Great!', vipInfoII:'All VIP I features + extra exclusive benefits', vipInfoIII:'Top tier — unmatched features', vipExclusiveMembership:'Exclusive Membership', vipComingSoon:'This tier will open soon', locked:'Locked',
  ...
  ru: {
    ...
    vipBoxClose:'Закрыть', vipBoxYouGot:'Вы получили', vipBoxGreat:'🎉 Отлично!', vipInfoII:'Все функции VIP I + дополнительные', vipInfoIII:'Высший уровень — лучшие функции', vipExclusiveMembership:'Эксклюзивное членство', vipComingSoon:'Этот уровень откроется скоро', locked:'Заблокировано',
  ...
  uk: {
    ...
    vipBoxClose:'Закрити', vipBoxYouGot:'Ви отримали', vipBoxGreat:'🎉 Чудово!', vipInfoII:'Всі функції VIP I + додаткові', vipInfoIII:'Найвищий рівень — найкращі функції', vipExclusiveMembership:'Ексклюзивне членство', vipComingSoon:'Цей рівень відкриється скоро', locked:'Заблоковано',
  ...
  pt: {
    ...
    vipBoxClose:'Fechar', vipBoxYouGot:'Você ganhou', vipBoxGreat:'🎉 Ótimo!', vipInfoII:'Todos os benefícios VIP I + extras', vipInfoIII:'Nível máximo — benefícios sem igual', vipExclusiveMembership:'Associação Exclusiva', vipComingSoon:'Este nível será aberto em breve', locked:'Bloqueado',
  ...
  es: {
    ...
    vipBoxClose:'Cerrar', vipBoxYouGot:'Obtuviste', vipBoxGreat:'🎉 ¡Genial!', vipInfoII:'Todos los beneficios VIP I + extras', vipInfoIII:'Nivel máximo — beneficios sin igual', vipExclusiveMembership:'Membresía Exclusiva', vipComingSoon:'Este nivel abrirá pronto', locked:'Bloqueado',
  ...
  tr: {
    ...
    vipBoxClose:'Kapat', vipBoxYouGot:'Aldınız', vipBoxGreat:'🎉 Harika!', vipInfoII:'Tüm VIP I özellikleri + ekstra', vipInfoIII:'En üst seviye — eşsiz özellikler', vipExclusiveMembership:'Özel Üyelik', vipComingSoon:'Bu seviye yakında açılacak', locked:'Kilitli',
  ...
  vi: {
    ...
    vipBoxClose:'Đóng', vipBoxYouGot:'Bạn nhận được', vipBoxGreat:'🎉 Tuyệt!', vipInfoII:'Tất cả tính năng VIP I + thêm', vipInfoIII:'Cấp cao nhất — tính năng vô song', vipExclusiveMembership:'Thành viên Độc quyền', vipComingSoon:'Cấp độ này sẽ mở sớm', locked:'Đã khóa',
  ...
  zh: {
    ...
    vipBoxClose:'关闭', vipBoxYouGot:'您获得了', vipBoxGreat:'🎉 太棒了！', vipInfoII:'所有VIP I功能+额外独家', vipInfoIII:'最高等级 — 无与伦比的功能', vipExclusiveMembership:'专属会员', vipComingSoon:'此等级即将开放', locked:'已锁定',
