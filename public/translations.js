...
var T = {
  ...
  catVip2:'💎 VIP 2',
    ...
    vipLevelsTitle:'👑 مستويات VIP', vipPriceLabelI:'1 TON / شهر', vipErrBoxOpen:'❌ خطأ في فتح الصندوق', vipErrWallet:'❌ ربط محفظتك أولاً من صفحة Wallet!', vipLoadingWallet:'⏳ جاري فتح محفظتك...', vipVerifying:'⏳ جاري التحقق من الدفع...', vipActivated:'👑 تم تفعيل VIP {tier} بنجاح!', vipVerifyFail:'فشل التحقق، تواصل مع الدعم', vipErrServer:'❌ خطأ في الاتصال بالسيرفر', vipCancelled:'تم إلغاء الدفع', vipErrPayment:'❌ خطأ في الدفع', vipBoostAlready:'✅ البوست مفعّل اليوم مسبقاً', vipBoostActivated2:'⚡ تم تفعيل ×١.٥ تعدين REC لبقية اليوم!', vip3Desc:'المستوى الأعلى — مميزات لا مثيل لها', vipWelcomeBonus:'🎁 +50 REC مكافأة ترحيبية!',
    // Combo timer
