...
var T = {
  ar: {
    ...
    support:'💬 الدعم الفني @Momokhli', comingSoon:'قريباً', vipExclusiveMembership:'عضوية حصرية', vipComingSoon:'سيُفتح هذا المستوى قريباً', locked:'مقفول',
    // Toasts
  ...
  en: {
    ...
    support:'💬 Support @Momokhli', comingSoon:'Coming Soon', vipExclusiveMembership:'Exclusive Membership', vipComingSoon:'This tier will open soon', locked:'Locked',
  ...
  ru: {
    ...
    support:'💬 Поддержка @Momokhli', comingSoon:'Скоро', vipExclusiveMembership:'Эксклюзивное членство', vipComingSoon:'Этот уровень откроется скоро', locked:'Заблокировано',
  ...
  uk: {
    ...
    support:'💬 Підтримка @Momokhli', comingSoon:'Незабаром', vipExclusiveMembership:'Ексклюзивне членство', vipComingSoon:'Цей рівень відкриється скоро', locked:'Заблоковано',
  ...
  pt: {
    ...
    support:'💬 Suporte @Momokhli', comingSoon:'Em breve', vipExclusiveMembership:'Associação Exclusiva', vipComingSoon:'Este nível será aberto em breve', locked:'Bloqueado',
  ...
  es: {
    ...
    support:'💬 Soporte @Momokhli', comingSoon:'Próximamente', vipExclusiveMembership:'Membresía Exclusiva', vipComingSoon:'Este nivel abrirá pronto', locked:'Bloqueado',
  ...
  tr: {
    ...
    support:'💬 Destek @Momokhli', comingSoon:'Yakında', vipExclusiveMembership:'Özel Üyelik', vipComingSoon:'Bu seviye yakında açılacak', locked:'Kilitli',
  ...
  vi: {
    ...
    support:'💬 Hỗ trợ @Momokhli', comingSoon:'Sắp có', vipExclusiveMembership:'Thành viên Độc quyền', vipComingSoon:'Cấp độ này sẽ mở sớm', locked:'Đã khóa',
  ...
  zh: {
    ...
    support:'💬 技术支持 @Momokhli', comingSoon:'即将推出', vipExclusiveMembership:'专属会员', vipComingSoon:'此等级即将开放', locked:'已锁定',
