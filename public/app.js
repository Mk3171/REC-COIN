...
// ====== TRANSLATIONS ======
var T = {
  ar:{dir:'rtl',tapMine:'اضغط للتعدين',energyLabel:'⚡ الطاقة',miningSpeedLabel:'تعدين REC:',recordSpeedLabel:'تعدين RECORD:',upgradesTitle:'الترقيات',tapUpgradeTitle:'⚡ ترقية الكبسات',energyUpgradeTitle:'🔋 ترقية الطاقة',levelLabel:'المستوى:',costLabel:'التكلفة:',tapsPerClick:'كبسات لكل ضغطة:',totalEnergy:'الطاقة الكلية:',upgradeBtn:'ترقية',backBtn:'← رجوع',cardsTitle:'🃏 البطاقات',catAnime:'🎌 أنمي',catCars:'🚗 سيارات',catClubs:'🌙 ملاهي',catPalaces:'🏰 قصور',catLimited:'🔥 محدود',cardLevel:'المستوى',cardUpgradeBtn:'ترقية',cardMaxLevel:'✅ وصلت للمستوى الأقصى!',cardMiningBonus:'تعدين هذه البطاقة',cardUpgradeCost:'تكلفة الترقية',cardWaitTime:'وقت الانتظار',upgrading:'⏳ جاري الترقية...',upgradeReady:'✅ جاهز',noMining:'⛔ لا يوجد تعدين - رقّ بطاقة أولاً',tasksTitle:'✅ المهام',telegramTask:'📱 انضم لجروب تيليغرام',joinGroupBtn:'انضم للجروب ←',twitterTask:'🐦 تابع على تويتر',followTwitterBtn:'تابع على تويتر ←',getRecord:'احصل على 10,000 RECORD',taskDone:'✅ تم الإنجاز',inviteTitle:'👥 الدعوة',inviteSubtitle:'ادعو أصدقاءك واربح عملات REC!',totalInvited:'إجمالي المدعوين',personJoined:'شخص انضم عبر رابطك',milestonesTitle:'🎯 مراحل المكافآت',copyLink:'📋 نسخ الرابط',shareBtn:'📤 مشاركة',claimBtn:'احصل! 🎁',inviteN:'ادعُ {n} شخص',rankTitle:'🏆 الترتيب',yourLevel:'مستواك الحالي',yourBalance:'رصيدك:',connectWallet:'ربط المحفظة',support:'💬 الدعم الفني @Momokhli',poolWallet:'Pool Wallet',withdrawable:'Withdrawable balance',controls:'Controls',withdrawPool:'Withdraw Pool',transferPool:'Transfer Pool to Wallet',history:'History',yourWithdrawals:'Your withdrawals',comingSoon:'Coming Soon',locked:'Locked',navHome:'الرئيسية',navCards:'البطاقات',navTasks:'المهام',navInvite:'الدعوة',navRank:'الترتيب',navProfile:'الملف',toastCopied:'✅ تم نسخ الرابط!',toastTask:'🎉 حصلت على 10,000 RECORD!',toastClaimed:'🎉 حصلت على {n} REC!',toastNotMet:'لم تكمل المتطلب بعد!',toastAlready:'أنجزت هذه المهمة مسبقاً!',toastUpgradeStart:'⏳ بدأت ترقية البطاقة!',toastUpgradeDone:'🎉 تمت الترقية!',toastNotEnoughRecord:'رصيد RECORD غير كافٍ!',toastAlreadyUpgrading:'البطاقة قيد الترقية!',withdrawalBtn:'سحب',withdrawTitle:'سحب REC',withdrawSubtitle:'سحب عملة REC الحقيقية لمحفظتك',withdrawBalance:'رصيدك المتاح',withdrawMin:'الحد الأدنى',withdrawFee:'رسوم السحب',withdrawDaily:'الحد اليومي المتبقي',withdrawAmount:'الكمية المراد سحبها',withdrawBtn:'🏛️ سحب REC الآن',withdrawReceive:'ستصلك:',withdrawAfterFee:'بعد خصم الرسوم',withdrawMinErr:'الحد الأدنى {n} REC',withdrawSuccess:'✅ تم إرسال {n} REC لمحفظتك!',withdrawNoWallet:'❌ ربط محفظة TON أولاً!',withdrawLowBal:'❌ رصيدك غير كافٍ',withdrawDailyErr:'❌ وصلت الحد اليومي. تبقى: {n} REC',withdrawFailed:'❌ فشل السحب',withdrawLoading:'⏳ جاري الإرسال...',rankTitle:'🏆 المتصدرون',tabGlobal:'🌍 عالمي',tabFriends:'👥 أصدقاء',tabMyLevel:'📊 مستواي',myRankLabel:'ترتيبك العالمي',weeklyChallenge:'🏆 التحدي الأسبوعي',weeklyPrize:'جائزة 1,000 REC',daysLeft:'يوم متبقي',loadingLeader:'⏳ جاري التحميل...',noFriends:'لم تدعُ أحداً بعد',totalMined:'إجمالي REC المعدن',sinceJoined:'منذ انضمامك',top100only:'أول 100 مشترك فقط',rewardDist:'توزيع المكافآت',rankReward:'مكافأتك المتوقعة',shopTitle:'متجر النجوم',shopSubtitle:'ادعم المشروع واحصل على مكافآت فورية!',shopNote:'⭐ النجوم تشترى من تيليغرام مباشرة',shopEnergy:'⚡ شحن طاقة فوري',shopEnergyDesc:'يرجع طاقتك كاملة فوراً',shopRecord500:'💰 500,000 RECORD',shopRecord500Desc:'تضاف فوراً لرصيدك',shopRecord3m:'💰 3,000,000 RECORD',shopRecord3mDesc:'الأفضل قيمة ⭐',shopSkip:'🚀 تخطي وقت الانتظار',shopSkipDesc:'أكمل ترقية البطاقة فوراً',toastInvoiceLoading:'⏳ جاري تحضير الفاتورة...',toastPaid:'✅ تم الدفع بنجاح! جاري تحديث رصيدك...',toastCancelled:'تم إلغاء الدفع',toastFailed:'❌ فشل الدفع، حاول مرة أخرى',toastConnError:'❌ خطأ في الاتصال بالسيرفر',sideDaily:'يومي',sideRank:'رتبة',sideGames:'ألعاب',sideCombo:'كومبو',sideUpgrade:'ترقية',sideShop:'متجر',navGames:'ألعاب',navWallet:'محفظة',qbTasks:'المهام',qbExchange:'تبادل',qbSwap:'تبديل',recordLabel:'سجل',recLabel:'REC',energyFull:'طاقة كاملة',walletTitle:'المحفظة',walletId:'المعرف',comboTitle:'كومبو يومي',comboSubtitle:'رقّ الثلاث بطاقات اليومية واحصل على مكافأة!',comboReward:'المكافأة اليومية',comboClaim:'احصل على +5 REC 🎉',comboClaimed:'✅ تم استلام المكافأة اليوم!',comboLocked:'لم يُحدد كومبو اليوم',comboAdmin:'اختر بطاقات الكومبو - ADMIN',comboSave:'💾 حفظ الكومبو اليومي',dailyRewardTitle:'المكافأة اليومية',dailyDay:'اليوم {n} / 30',dailyClaimed:'تم الاستلام اليوم ✅',dailyComeBack:'عد غداً',dailyClaimBtn:'✅ استلم',dailyClaimNow:'احصل على المكافأة 🎁',shopEnergyTitle:'شحن الطاقة',shopEnergyRefillLabel:'⚡ شحن طاقة فوري',energyRefillTitle:'⚡ شحن الطاقة',energyRefillDesc:'اشحن طاقتك فوراً',remainingToday:'المتبقي اليوم:',refillEnergyBtn:'⚡ شحن الطاقة',partnerProgram:'برنامج الشركاء',partnerDesc:'ادعُ أصدقاء واكسب عمولة REC من تعدينهم وبلوكاتهم.',commissionRates:'معدلات العمولة',typeLabel:'النوع',miningLabel:'⛏️ تعدين',blockLabel:'🏆 بلوك',recEarned:'REC المكتسب',friendsLabel:'الأصدقاء',rewardMilestones:'🎯 مراحل المكافآت',menuSupport:'الدعم الفني',menuNews:'الأخبار',menuNewsDesc:'التحديثات والإعلانات',menuChat:'الدردشة',menuChatDesc:'دردشة المجتمع',menuPayouts:'المدفوعات',menuFaq:'الأسئلة الشائعة والشروط',menuFaqDesc:'القواعد والشروط',walletAssets:'الأصول',walletControls:'الإجراءات',walletOpen:'فتح →',walletSoon:'🔒 قريباً',recInfoTitle:'⚡ عملة REC',recInfoSub:'كيف تجمع REC وكيف تزيد سرعة تعدينك',recAutoMining:'التعدين التلقائي',recAutoMiningDesc:'بطاقات التعدين تعطيك REC تلقائياً كل ثانية. كلما رقيت بطاقة أكثر كلما زادت سرعة التعدين.',recYourSpeed:'سرعتك الحالية:',recCardUpgrade:'ترقية البطاقات',recCardUpgradeDesc:'كل ترقية بطاقة تزيد سرعة تعدين REC. البطاقات المحدودة تعطي ×3 سرعة.',recNormalCard:'بطاقة عادية',recLimitedCard:'بطاقة محدودة ⭐',recBlocks:'البلوكات',recBlocksDesc:'كل ضغطة على الدائرة لديك فرصة للحصول على بلوك يعطيك مكافأة كبيرة من REC فجأة!',recDailyCombo:'الكومبو اليومي',recDailyComboDesc:'رقّ الثلاث بطاقات السرية اليومية واحصل على مكافأة +5 REC. الكومبو يتجدد كل يوم.',recReferrals:'الإحالات',recReferralsDesc:'ادعُ أصدقاءك واكسب عمولة من تعدينهم:',recTasks:'المهام',recTasksDesc:'أكمل مهام التواصل الاجتماعي والمهام اليومية للحصول على REC إضافية.',recSpeedTip:'💡 نصيحة لزيادة السرعة',recTip1:'رقّ البطاقات المحدودة أولاً (×3 سرعة)',recTip2:'ارفع مستوى البطاقات العالية باستمرار',recTip3:'أكمل الكومبو اليومي كل يوم',recTip4:'ادعُ أصدقاء للحصول على عمولة مستمرة',recordInfoTitle:'🔴 عملة RECORD',recordInfoSub:'كيف تجمع RECORD وما هو دورها',recordWhat:'ما هي عملة RECORD؟',recordWhatSub:'عملة التعدين الأساسية',recordWhatDesc:'RECORD هي العملة الرئيسية في اللعبة. تُستخدم لترقية البطاقات وشراء العناصر. رصيدك الحالي:',recordTapping:'الضغط على الدائرة',recordTappingSub:'الطريقة الأسرع',recordTappingDesc:'كل ضغطة على الدائرة الحمراء تعطيك RECORD. كلما زادت قوة الضغط كلما حصلت على أكثر في كل ضغطة.',recordTapPower:'ترقية Tap Power',recordMorePerTap:'↑ RECORD/ضغطة',recordEnergyUp:'ترقية Energy',recordMoreTaps:'↑ ضغطات أكثر',recordAutoMining:'التعدين التلقائي',recordAutoSub:'مستمر 24/7',recordAutoDesc:'البطاقات تعدّن RECORD تلقائياً حتى وأنت غير متصل.',recordYourSpeed:'سرعتك:',recordMystery:'Mystery Box',recordMysterySub:'مجاناً كل يوم',recordMysteryDesc:'افتح صندوق المفاجآت اليومي مجاناً من قسم Tasks. قد تحصل على كمية كبيرة من RECORD أو REC!',recordEnergyRefill:'إعادة شحن الطاقة',recordEnergyRefillSub:'مرتان يومياً مجاناً',recordEnergyRefillDesc:'عندما تنتهي طاقتك يمكنك إعادة شحنها مرتين يومياً مجاناً.',recordHowSpend:'💡 كيف تستخدم RECORD؟',recordSpend1:'🃏 ترقية بطاقات التعدين لزيادة سرعة REC',recordSpend2:'⬆️ رفع مستوى Tap Power للحصول على أكثر لكل ضغطة',recordSpend3:'⚡ توسيع سعة الطاقة لضغطات أكثر',recordSpend4:'⭐ شراء بطاقات محدودة من المتجر',ppCardsUpgraded:'البطاقات المرقاة',ppRecSpeed:'سرعة REC',ppRecord:'RECORD',ppRecBalance:'رصيد REC',ppTotalTaps:'إجمالي الضغطات',ppTasksDone:'المهام المنجزة',ppFriends:'الأصدقاء',ppCardLevels:'مستويات البطاقات',ppTopCards:'أفضل البطاقات',ppNoCards:'لا توجد بطاقات مرقاة بعد',mysteryTitle:'📦 صندوق المفاجآت',mysterySubtitle:'مجاناً يومياً — اكسب RECORD أو REC!',mysteryOpenBtn:'فتح 🎲',mysteryAlready:'تم الفتح اليوم — عد غداً!',mysteryYouGot:'حصلت على:'},
  en:{dir:'ltr',tapMine:'Tap to Mine',energyLabel:'⚡ Energy',miningSpeedLabel:'REC Mining:',recordSpeedLabel:'RECORD Mining:',upgradesTitle:'Upgrades',tapUpgradeTitle:'⚡ Tap Upgrade',energyUpgradeTitle:'🔋 Energy Upgrade',levelLabel:'Level:',costLabel:'Cost:',tapsPerClick:'Taps per click:',totalEnergy:'Total Energy:',upgradeBtn:'Upgrade',backBtn:'← Back',cardsTitle:'🃏 Cards',catAnime:'🎌 Anime',catCars:'🚗 Cars',catClubs:'🌙 Clubs',catPalaces:'🏰 Palaces',catLimited:'🔥 Limited',cardMiningBonus:'Card Mining',cardUpgradeCost:'Upgrade Cost',cardWaitTime:'Wait Time',upgrading:'⏳ Upgrading...',upgradeReady:'✅ Ready',noMining:'⛔ No mining — upgrade a card first',tasksTitle:'✅ Tasks',telegramTask:'📱 Join Telegram Group',joinGroupBtn:'Join Group →',twitterTask:'🐦 Follow on Twitter',followTwitterBtn:'Follow Twitter →',getRecord:'Get 10,000 RECORD',taskDone:'✅ Completed',inviteTitle:'👥 Invite',inviteSubtitle:'Invite friends and earn REC!',totalInvited:'Total Invited',personJoined:'people joined via your link',milestonesTitle:'🎯 Reward Milestones',copyLink:'📋 Copy Link',shareBtn:'📤 Share',claimBtn:'Claim! 🎁',inviteN:'Invite {n} people',rankTitle:'🏆 Ranking',yourLevel:'Your Current Level',yourBalance:'Your Balance:',connectWallet:'Connect Wallet',support:'💬 Support @Momokhli',poolWallet:'Pool Wallet',withdrawable:'Withdrawable balance',controls:'Controls',withdrawPool:'Withdraw Pool',transferPool:'Transfer Pool to Wallet',history:'History',yourWithdrawals:'Your withdrawals',comingSoon:'Coming Soon',locked:'Locked',navHome:'Home',navCards:'Cards',navTasks:'Tasks',navInvite:'Invite',navRank:'Rank',navProfile:'Profile',toastCopied:'✅ Link Copied!',toastTask:'🎉 Got 10,000 RECORD!',toastClaimed:'🎉 Got {n} REC!',toastNotMet:'Requirement not met!',toastAlready:'Task already completed!',toastUpgradeStart:'⏳ Card upgrade started!',toastUpgradeDone:'🎉 Upgrade complete!',toastNotEnoughRecord:'Not enough RECORD!',toastAlreadyUpgrading:'Card already upgrading!',withdrawalBtn:'Withdrawal',withdrawTitle:'Withdraw REC',withdrawSubtitle:'Withdraw real REC to your wallet',withdrawBalance:'Available Balance',withdrawMin:'Minimum',withdrawFee:'Fee',withdrawDaily:'Daily Remaining',withdrawAmount:'Amount to withdraw',withdrawBtn:'🏛️ Withdraw REC Now',withdrawReceive:'You will receive:',withdrawAfterFee:'after fee',withdrawMinErr:'Minimum {n} REC',withdrawSuccess:'✅ Sent {n} REC to your wallet!',withdrawNoWallet:'❌ Connect TON wallet first!',withdrawLowBal:'❌ Insufficient balance',withdrawDailyErr:'❌ Daily limit reached. Remaining: {n} REC',withdrawFailed:'❌ Withdrawal failed',withdrawLoading:'⏳ Sending...',rankTitle:'🏆 LEADERBOARD',tabGlobal:'🌍 Global',tabFriends:'👥 Friends',tabMyLevel:'📊 My Level',myRankLabel:'Your Global Rank',weeklyChallenge:'🏆 Weekly Challenge',weeklyPrize:'Prize: 1,000 REC',daysLeft:'days left',loadingLeader:'⏳ Loading...',noFriends:'You have not invited anyone yet',totalMined:'Total REC Mined',sinceJoined:'since you joined',top100only:'Top 100 players only',rewardDist:'Reward Distribution',rankReward:'Your expected reward',shopTitle:'Stars Shop',shopSubtitle:'Support the project and get instant rewards!',shopNote:'⭐ Stars are purchased directly from Telegram',shopEnergy:'⚡ Instant Energy Refill',shopEnergyDesc:'Refills your energy completely',shopRecord500:'💰 500,000 RECORD',shopRecord500Desc:'Added to your balance instantly',shopRecord3m:'💰 3,000,000 RECORD',shopRecord3mDesc:'Best value ⭐',shopSkip:'🚀 Skip Wait Timer',shopSkipDesc:'Complete card upgrade instantly',toastInvoiceLoading:'⏳ Preparing invoice...',toastPaid:'✅ Payment successful! Updating balance...',toastCancelled:'Payment cancelled',toastFailed:'❌ Payment failed, try again',toastConnError:'❌ Connection error',sideDaily:'Daily',sideRank:'Rank',sideGames:'Games',sideCombo:'Combo',sideUpgrade:'Upgrade',sideShop:'Shop',navGames:'Games',navWallet:'Wallet',qbTasks:'Tasks',qbExchange:'Exchange',qbSwap:'Swap',recordLabel:'Record',recLabel:'REC',energyFull:'Full Energy',walletTitle:'Wallet',walletId:'ID',comboTitle:'Daily Combo',comboSubtitle:'Upgrade the 3 daily cards and get a reward!',comboReward:'Daily Reward',comboClaim:'Claim +5 REC 🎉',comboClaimed:'✅ Reward claimed today!',comboLocked:'No combo set today',comboAdmin:'Choose Combo Cards - ADMIN',comboSave:'💾 Save Daily Combo',dailyRewardTitle:'Daily Reward',dailyDay:'Day {n} / 30',dailyClaimed:'Already claimed today ✅',dailyComeBack:t('dailyComeBack'),dailyClaimBtn:t('dailyClaimBtn'),dailyClaimNow:t('dailyClaimNow'),shopEnergyTitle:'Energy Refill',shopEnergyRefillLabel:'⚡ Instant Energy Refill',energyRefillTitle:'Energy Refill ⚡',energyRefillDesc:'Instantly refill your energy',remainingToday:'Remaining today:',refillEnergyBtn:'Refill Energy ⚡',partnerProgram:'PARTNER PROGRAM',partnerDesc:'Invite friends & earn REC from their mining and blocks.',commissionRates:'COMMISSION RATES',typeLabel:'TYPE',miningLabel:'⛏️ Mining',blockLabel:'🏆 Block',recEarned:'REC EARNED',friendsLabel:'FRIENDS',rewardMilestones:'🎯 REWARD MILESTONES',menuSupport:'Support',menuNews:'News',menuNewsDesc:'Updates & Announcements',menuChat:'Chat',menuChatDesc:'Community Chat',menuPayouts:'Payouts',menuFaq:'FAQ & Terms',menuFaqDesc:'Rules & Conditions',walletAssets:'Assets',walletControls:'CONTROLS',walletOpen:'Open →',walletSoon:'🔒 SOON',recInfoTitle:'⚡ REC Token',recInfoSub:'How to earn REC and increase mining speed',recAutoMining:'Auto Mining',recAutoMiningDesc:'Mining cards give you REC automatically every second. The more you upgrade, the faster your mining.',recYourSpeed:'Your current speed:',recCardUpgrade:'Card Upgrades',recCardUpgradeDesc:'Each card upgrade increases REC mining speed. Limited cards give ×3 speed.',recNormalCard:'Normal Card',recLimitedCard:'Limited Card ⭐',recBlocks:'Blocks',recBlocksDesc:'Every tap has a chance to find a block giving you a big REC reward!',recDailyCombo:'Daily Combo',recDailyComboDesc:'Upgrade the 3 secret daily cards and get +5 REC reward. Combo resets daily.',recReferrals:'Referrals',recReferralsDesc:'Invite friends and earn commission from their mining:',recTasks:'Tasks',recTasksDesc:'Complete social and daily tasks for extra REC rewards.',recSpeedTip:'💡 Speed Increase Tips',recTip1:'Upgrade limited cards first (×3 speed)',recTip2:'Keep upgrading high-level cards',recTip3:'Complete daily combo every day',recTip4:'Invite friends for continuous commission',recordInfoTitle:'🔴 RECORD Token',recordInfoSub:'How to earn RECORD and its role',recordWhat:'What is RECORD?',recordWhatSub:'The main mining currency',recordWhatDesc:'RECORD is the main in-game currency used to upgrade cards and buy items. Your balance:',recordTapping:'Tapping the Circle',recordTappingSub:'The fastest method',recordTappingDesc:'Each tap on the red circle gives RECORD. More Tap Power = more per tap.',recordTapPower:'Upgrade Tap Power',recordMorePerTap:'↑ RECORD/tap',recordEnergyUp:'Upgrade Energy',recordMoreTaps:'↑ More taps',recordAutoMining:'Auto Mining',recordAutoSub:'Continuous 24/7',recordAutoDesc:'Cards mine RECORD automatically even when offline.',recordYourSpeed:'Your speed:',recordMystery:'Mystery Box',recordMysterySub:'Free every day',recordMysteryDesc:'Open the free daily mystery box from Tasks. You may get a large amount of RECORD or REC!',recordEnergyRefill:'Energy Refill',recordEnergyRefillSub:'Twice a day for free',recordEnergyRefillDesc:'When your energy runs out you can refill it twice daily for free.',recordHowSpend:'💡 How to use RECORD?',recordSpend1:'🃏 Upgrade mining cards to increase REC speed',recordSpend2:'⬆️ Upgrade Tap Power for more per tap',recordSpend3:'⚡ Expand energy capacity for more taps',recordSpend4:'⭐ Buy limited cards from the shop',ppCardsUpgraded:'CARDS UPGRADED',ppRecSpeed:'REC SPEED',ppRecord:'RECORD',ppRecBalance:'REC BALANCE',ppTotalTaps:'TOTAL TAPS',ppTasksDone:'TASKS DONE',ppFriends:'FRIENDS',ppCardLevels:'CARD LEVELS',ppTopCards:'Top Cards',ppNoCards:t('ppNoCards'),mysteryTitle:t('mysteryTitle'),mysterySubtitle:'Free daily — win RECORD or REC!',mysteryOpenBtn:t('mysteryOpenBtn'),mysteryAlready:'Already opened today — come back tomorrow!',mysteryYouGot:t('mysteryYouGot')},
  uk:{dir:'ltr',tapMine:'Натисніть для майнінгу',energyLabel:'⚡ Енергія',miningSpeedLabel:'Майнінг REC:',recordSpeedLabel:'Майнінг RECORD:',upgradesTitle:'Покращення',tapUpgradeTitle:'⚡ Покращення натискань',energyUpgradeTitle:'🔋 Покращення енергії',levelLabel:'Рівень:',costLabel:'Вартість:',tapsPerClick:'Натискань за клік:',totalEnergy:'Загальна енергія:',upgradeBtn:'Покращити',backBtn:'← Назад',cardsTitle:'🃏 Картки',catAnime:'🎌 Аніме',catCars:'🚗 Машини',catClubs:'🌙 Клуби',catPalaces:'🏰 Палаци',catLimited:'🔥 Обмежені',cardUpgradeBtn:'Покращити',cardMaxLevel:'✅ Максимальний рівень!',cardMiningBonus:'Майнінг картки',cardUpgradeCost:'Вартість покращення',cardWaitTime:'Час очікування',upgrading:'⏳ Покращення...',upgradeReady:'✅ Готово',noMining:'⛔ Немає майнінгу — покращіть картку!',tasksTitle:'✅ Завдання',telegramTask:'📱 Приєднатися до Telegram',joinGroupBtn:'Приєднатися →',twitterTask:'🐦 Підписатися в Twitter',followTwitterBtn:'Підписатися →',getRecord:'Отримати 10,000 RECORD',taskDone:'✅ Виконано',inviteTitle:'👥 Запросити',inviteSubtitle:'Запрошуйте друзів і заробляйте REC!',totalInvited:'Всього запрошено',personJoined:'людей приєдналися',milestonesTitle:'🎯 Етапи винагород',copyLink:'📋 Копіювати посилання',shareBtn:'📤 Поділитися',claimBtn:'Отримати! 🎁',inviteN:'Запросіть {n} людей',rankTitle:'🏆 Рейтинг',yourLevel:'Ваш поточний рівень',yourBalance:'Ваш баланс:',connectWallet:'Підключити гаманець',support:'💬 Підтримка @Momokhli',poolWallet:'Pool Wallet',withdrawable:'Доступний баланс',controls:'Управління',withdrawPool:'Вивести Pool',transferPool:'Перевести в гаманець',history:'Історія',yourWithdrawals:'Ваші виведення',comingSoon:'Незабаром',locked:'Заблоковано',navHome:'Home',navCards:'Cards',navTasks:'Tasks',navInvite:'Invite',navRank:'Rank',navProfile:'Profile',toastCopied:'✅ Посилання скопійовано!',toastTask:'🎉 Отримано 10,000 RECORD!',toastClaimed:'🎉 Отримано {n} REC!',toastNotMet:'Вимога не виконана!',toastAlready:'Завдання вже виконано!',toastUpgradeStart:'⏳ Покращення розпочато!',toastUpgradeDone:'🎉 Покращення завершено!',toastNotEnoughRecord:'Недостатньо RECORD!',toastAlreadyUpgrading:'Картка вже покращується!',withdrawalBtn:'Виведення',withdrawTitle:'Вивести REC',withdrawSubtitle:'Виведення реального REC на гаманець',withdrawBalance:'Доступний баланс',withdrawMin:'Мінімум',withdrawFee:'Комісія',withdrawDaily:'Залишок ліміту',withdrawAmount:'Сума виведення',withdrawBtn:'🏛️ Вивести REC',withdrawReceive:'Ви отримаєте:',withdrawAfterFee:'після комісії',withdrawMinErr:'Мінімум {n} REC',withdrawSuccess:'✅ Відправлено {n} REC!',withdrawNoWallet:'❌ Підключіть гаманець!',withdrawLowBal:'❌ Недостатньо коштів',withdrawDailyErr:'❌ Ліміт. Залишок: {n} REC',withdrawFailed:'❌ Помилка виведення',withdrawLoading:'⏳ Відправка...',rankTitle:'🏆 ЛІДЕРБОРД',tabGlobal:'🌍 Глобально',tabFriends:'👥 Друзі',tabMyLevel:'📊 Мій рівень',myRankLabel:'Ваш глобальний ранг',weeklyChallenge:'🏆 Тижневий виклик',weeklyPrize:'Приз: 1,000 REC',daysLeft:'днів залишилось',loadingLeader:'⏳ Завантаження...',noFriends:'Ви ще нікого не запросили',totalMined:'Всього REC здобуто',sinceJoined:'з моменту приєднання',top100only:'Тільки топ 100',rewardDist:'Розподіл нагород',rankReward:'Очікувана нагорода',shopTitle:'Магазин зірок',shopSubtitle:'Підтримайте проект і отримайте нагороди!',shopNote:'⭐ Зірки купуються в Telegram',shopEnergy:'⚡ Миттєва зарядка енергії',shopEnergyDesc:'Повністю відновлює енергію',shopRecord500:'💰 500,000 RECORD',shopRecord500Desc:'Додається на баланс миттєво',shopRecord3m:'💰 3,000,000 RECORD',shopRecord3mDesc:'Найкраща цінність ⭐',shopSkip:'🚀 Пропустити очікування',shopSkipDesc:'Завершити покращення карти миттєво',toastInvoiceLoading:'⏳ Підготовка рахунку...',toastPaid:'✅ Оплата успішна! Оновлення балансу...',toastCancelled:'Оплату скасовано',toastFailed:'❌ Помилка оплати',toastConnError:'❌ Помилка з\'єднання',sideDaily:'Щодня',sideRank:'Рейтинг',sideGames:'Ігри',sideCombo:'Комбо',sideUpgrade:'Покращити',sideShop:'Магазин',navGames:'Ігри',navWallet:'Гаманець',qbTasks:'Завдання',qbExchange:'Обмін',qbSwap:'Своп',recordLabel:'Рекорд',recLabel:'REC',energyFull:'Повна енергія',walletTitle:'Гаманець',walletId:'ID',comboTitle:'Щоденне Комбо',comboSubtitle:'Покращи 3 щоденні карти та отримай нагороду!',comboReward:'Щоденна нагорода',comboClaim:'Отримати +5 REC 🎉',comboClaimed:'✅ Нагороду отримано сьогодні!',comboLocked:'Комбо не встановлено',comboAdmin:'Вибрати карти Комбо - ADMIN',comboSave:'💾 Зберегти Комбо',dailyRewardTitle:'Щоденна нагорода',dailyDay:'День {n} / 30',dailyClaimed:'Вже отримано сьогодні ✅',dailyComeBack:'Повертайтесь завтра',dailyClaimBtn:'✅ Отримано',dailyClaimNow:'Отримати нагороду 🎁',shopEnergyTitle:'Зарядка енергії',shopEnergyRefillLabel:'⚡ Миттєва зарядка',energyRefillTitle:'Зарядка Енергії ⚡',energyRefillDesc:'Миттєво відновити енергію',remainingToday:'Залишилось сьогодні:',refillEnergyBtn:'Зарядити Енергію ⚡',partnerProgram:'ПАРТНЕРСЬКА ПРОГРАМА',partnerDesc:'Запрошуй друзів та заробляй REC від їх майнінгу.',commissionRates:'СТАВКИ КОМІСІЇ',typeLabel:'ТИП',miningLabel:'⛏️ Майнінг',blockLabel:'🏆 Блок',recEarned:'ЗАРОБЛЕНО REC',friendsLabel:'ДРУЗІ',rewardMilestones:'🎯 ЕТАПИ НАГОРОД',menuSupport:'Підтримка',menuNews:'Новини',menuNewsDesc:'Оновлення та оголошення',menuChat:'Чат',menuChatDesc:'Чат спільноти',menuPayouts:'Виплати',menuFaq:'FAQ та Умови',menuFaqDesc:'Правила та умови',walletAssets:'Активи',walletControls:'УПРАВЛІННЯ',walletOpen:'Відкрити →',walletSoon:'🔒 СКОРО'},
  ru:{dir:'ltr',tapMine:'Нажмите для майнинга',energyLabel:'⚡ Энергия',miningSpeedLabel:'Майнинг REC:',recordSpeedLabel:'Майнинг RECORD:',upgradesTitle:'Улучшения',tapUpgradeTitle:'⚡ Улучшение кликов',energyUpgradeTitle:'🔋 Улучшение энергии',levelLabel:'Уровень:',costLabel:'Стоимость:',tapsPerClick:'Кликов за нажатие:',totalEnergy:'Общая энергия:',upgradeBtn:'Улучшить',backBtn:'← Назад',cardsTitle:'🃏 Карточки',catAnime:'🎌 Аниме',catCars:'🚗 Машины',catClubs:'🌙 Клубы',catPalaces:'🏰 Дворцы',catLimited:'🔥 Лимит',cardLevel:'Уровень',cardUpgradeBtn:'Улучшить',cardMaxLevel:'✅ Максимальный уровень!',cardMiningBonus:'Майнинг карты',cardUpgradeCost:'Стоимость улучшения',cardWaitTime:'Время ожидания',upgrading:'⏳ Улучшение...',upgradeReady:'✅ Готово',noMining:'⛔ Нет майнинга — улучшите карту!',tasksTitle:'✅ Задания',telegramTask:'📱 Присоединиться к Telegram',joinGroupBtn:'Вступить →',twitterTask:'🐦 Подписаться в Twitter',followTwitterBtn:'Подписаться →',getRecord:'Получить 10,000 RECORD',taskDone:'✅ Выполнено',inviteTitle:'👥 Приглашение',inviteSubtitle:'Приглашайте друзей и зарабатывайте REC!',totalInvited:'Всего приглашено',personJoined:'человек присоединились',milestonesTitle:'🎯 Этапы наград',copyLink:'📋 Копировать ссылку',shareBtn:'📤 Поделиться',claimBtn:'Получить! 🎁',inviteN:'Пригласить {n} человек',rankTitle:'🏆 ЛИДЕРБОРД',yourLevel:'Ваш текущий уровень',yourBalance:'Ваш баланс:',connectWallet:'Подключить кошелёк',support:'💬 Поддержка @Momokhli',poolWallet:'Pool кошелёк',withdrawable:'Доступный баланс',controls:'Управление',withdrawPool:'Вывести Pool',transferPool:'Перевести в кошелёк',history:'История',yourWithdrawals:'Ваши выводы',comingSoon:'Скоро',locked:'Заблокировано',navHome:'Главная',navCards:'Карты',navTasks:'Задания',navInvite:'Пригласить',navRank:'Рейтинг',navProfile:'Профиль',toastCopied:'✅ Ссылка скопирована!',toastTask:'🎉 Получено 10,000 RECORD!',toastClaimed:'🎉 Получено {n} REC!',toastNotMet:'Требование не выполнено!',toastAlready:'Задание уже выполнено!',toastUpgradeStart:'⏳ Улучшение карты начато!',toastUpgradeDone:'🎉 Улучшение завершено!',toastNotEnoughRecord:'Недостаточно RECORD!',toastAlreadyUpgrading:'Карта уже улучшается!',withdrawalBtn:'Вывод',withdrawTitle:'Вывести REC',withdrawSubtitle:'Вывод REC на кошелёк',withdrawBalance:'Доступный баланс',withdrawMin:'Минимум',withdrawFee:'Комиссия',withdrawDaily:'Остаток лимита',withdrawAmount:'Сумма вывода',withdrawBtn:'🏛️ Вывести REC',withdrawReceive:'Вы получите:',withdrawAfterFee:'после комиссии',withdrawMinErr:'Минимум {n} REC',withdrawSuccess:'✅ Отправлено {n} REC!',withdrawNoWallet:'❌ Подключите кошелёк!',withdrawLowBal:'❌ Недостаточно средств',withdrawDailyErr:'❌ Лимит. Остаток: {n} REC',withdrawFailed:'❌ Ошибка вывода',withdrawLoading:'⏳ Отправка...',tabGlobal:'🌍 Глобально',tabFriends:'👥 Друзья',tabMyLevel:'📊 Мой уровень',myRankLabel:'Ваш глобальный ранг',weeklyChallenge:'🏆 Недельный вызов',weeklyPrize:'Приз: 1,000 REC',daysLeft:'дней осталось',loadingLeader:'⏳ Загрузка...',noFriends:'Вы ещё никого не пригласили',shopTitle:'Магазин звёзд',shopSubtitle:'Поддержите проект и получите награды!',shopNote:'⭐ Звёзды покупаются в Telegram',shopEnergy:'⚡ Мгновенная зарядка',shopEnergyDesc:'Полностью восстанавливает энергию',shopRecord500:'💰 500,000 RECORD',shopRecord500Desc:'Добавляется мгновенно',shopRecord3m:'💰 3,000,000 RECORD',shopRecord3mDesc:'Лучшая ценность ⭐',shopSkip:'🚀 Пропустить ожидание',shopSkipDesc:'Завершить улучшение мгновенно',toastInvoiceLoading:'⏳ Подготовка счёта...',toastPaid:'✅ Оплата успешна!',toastCancelled:'Оплата отменена',toastFailed:'❌ Ошибка оплаты',toastConnError:'❌ Ошибка соединения',sideDaily:'Ежедневно',sideRank:'Рейтинг',sideGames:'Игры',sideCombo:'Комбо',sideUpgrade:'Улучшить',sideShop:'Магазин',navGames:'Игры',navWallet:'Кошелёк',qbTasks:'Задания',qbExchange:'Обмен',qbSwap:'Своп',recordLabel:'Рекорд',recLabel:'REC',energyFull:'Полная энергия',walletTitle:'Кошелёк',walletId:'ID',comboTitle:'Ежедневное Комбо',comboSubtitle:'Улучши 3 ежедневные карты и получи награду!',comboReward:'Ежедневная награда',comboClaim:'Получить +5 REC 🎉',comboClaimed:'✅ Награда получена сегодня!',comboLocked:'Комбо не установлено',comboAdmin:'Выбрать карты Комбо - ADMIN',comboSave:'💾 Сохранить Комбо',totalMined:'Всего добыто REC',rewardDist:'Распределение наград',rankReward:'Ожидаемая награда',top100only:'Только топ 100',sinceJoined:'с момента входа',dailyRewardTitle:'Ежедневная награда',dailyDay:'День {n} / 30',dailyClaimed:'Уже получено сегодня ✅',dailyComeBack:'Возвращайтесь завтра',dailyClaimBtn:'✅ Получено',dailyClaimNow:'Получить награду 🎁',shopEnergyTitle:'Зарядка энергии',shopEnergyRefillLabel:'⚡ Мгновенная зарядка',energyRefillTitle:'Зарядка Энергии ⚡',energyRefillDesc:'Мгновенно восстановить энергию',remainingToday:'Осталось сегодня:',refillEnergyBtn:'Зарядить Энергию ⚡',partnerProgram:'ПАРТНЁРСКАЯ ПРОГРАММА',partnerDesc:'Приглашай друзей и зарабатывай REC от их майнинга.',commissionRates:'СТАВКИ КОМИССИИ',typeLabel:'ТИП',miningLabel:'⛏️ Майнинг',blockLabel:'🏆 Блок',recEarned:'ЗАРАБОТАНО REC',friendsLabel:'ДРУЗЬЯ',rewardMilestones:'🎯 ЭТАПЫ НАГРАД',menuSupport:'Поддержка',menuNews:'Новости',menuNewsDesc:'Обновления и объявления',menuChat:'Чат',menuChatDesc:'Чат сообщества',menuPayouts:'Выплаты',menuFaq:'FAQ и Условия',menuFaqDesc:'Правила и условия',walletAssets:'Активы',walletControls:'УПРАВЛЕНИЕ',walletOpen:'Открыть →',walletSoon:'🔒 СКОРО',recInfoTitle:'⚡ Токен REC',recInfoSub:'Как зарабатывать REC и увеличивать скорость майнинга',recAutoMining:'Автоматический майнинг',recAutoMiningDesc:'Карточки майнинга автоматически дают REC каждую секунду.',recYourSpeed:'Ваша текущая скорость:',recCardUpgrade:'Улучшение карточек',recCardUpgradeDesc:'Каждое улучшение карточки увеличивает скорость майнинга REC.',recNormalCard:'Обычная карта',recLimitedCard:'Лимитная карта ⭐',recBlocks:'Блоки',recBlocksDesc:'Каждое нажатие даёт шанс найти блок с большой наградой REC!',recDailyCombo:'Ежедневное комбо',recDailyComboDesc:'Улучшите 3 секретные карточки дня и получите +5 REC.',recReferrals:'Рефералы',recReferralsDesc:'Приглашайте друзей и зарабатывайте комиссию от их майнинга:',recTasks:'Задания',recTasksDesc:'Выполняйте социальные и ежедневные задания для получения REC.',recSpeedTip:'💡 Советы по увеличению скорости',recTip1:'Сначала улучшайте лимитные карты (×3 скорость)',recTip2:'Продолжайте улучшать карточки высокого уровня',recTip3:'Выполняйте ежедневное комбо каждый день',recTip4:'Приглашайте друзей для непрерывной комиссии',recordInfoTitle:'🔴 Токен RECORD',recordInfoSub:'Как зарабатывать RECORD и её роль',recordWhat:'Что такое RECORD?',recordWhatSub:'Основная валюта майнинга',recordWhatDesc:'RECORD — основная игровая валюта для улучшения карточек и покупки предметов.',recordTapping:'Нажатие на круг',recordTappingSub:'Самый быстрый метод',recordTappingDesc:'Каждое нажатие на красный круг даёт RECORD.',recordTapPower:'Улучшить Tap Power',recordMorePerTap:'↑ RECORD/нажатие',recordEnergyUp:'Улучшить Energy',recordMoreTaps:'↑ Больше нажатий',recordAutoMining:'Автоматический майнинг',recordAutoSub:'Непрерывно 24/7',recordAutoDesc:'Карточки автоматически добывают RECORD даже оффлайн.',recordYourSpeed:'Ваша скорость:',recordMystery:'Загадочная коробка',recordMysterySub:'Бесплатно каждый день',recordMysteryDesc:'Откройте бесплатную ежедневную коробку из раздела Tasks.',recordEnergyRefill:'Зарядка энергии',recordEnergyRefillSub:'Дважды в день бесплатно',recordEnergyRefillDesc:'Когда энергия заканчивается, её можно восстановить дважды в день.',recordHowSpend:'💡 Как использовать RECORD?',recordSpend1:'🃏 Улучшение карточек майнинга',recordSpend2:'⬆️ Улучшение Tap Power',recordSpend3:'⚡ Расширение ёмкости энергии',recordSpend4:'⭐ Покупка лимитных карточек',ppCardsUpgraded:'УЛУЧШЕННЫХ КАРТ',ppRecSpeed:'СКОРОСТЬ REC',ppRecord:'RECORD',ppRecBalance:'БАЛАНС REC',ppTotalTaps:'ВСЕГО НАЖАТИЙ',ppTasksDone:'ЗАДАНИЙ ВЫПОЛНЕНО',ppFriends:'ДРУЗЬЯ',ppCardLevels:'УРОВНИ КАРТ',ppTopCards:'Лучшие карты',ppNoCards:'Карточки ещё не улучшены',mysteryTitle:'📦 Таинственная коробка',mysterySubtitle:'Бесплатно ежедневно — выиграйте RECORD или REC!',mysteryOpenBtn:'Открыть 🎲',mysteryAlready:'Уже открыто сегодня — вернитесь завтра!',mysteryYouGot:'Вы получили:'},
  pt:{dir:'ltr',tapMine:'Toque para Minerar',energyLabel:'⚡ Energia',miningSpeedLabel:'Mineração REC:',recordSpeedLabel:'Mineração RECORD:',upgradesTitle:'Melhorias',tapUpgradeTitle:'⚡ Melhoria de Toque',energyUpgradeTitle:'🔋 Melhoria de Energia',levelLabel:'Nível:',costLabel:'Custo:',tapsPerClick:'Toques por clique:',totalEnergy:'Energia Total:',upgradeBtn:'Melhorar',backBtn:'← Voltar',cardsTitle:'🃏 Cartas',catAnime:'🎌 Anime',catCars:'🚗 Carros',catClubs:'🌙 Clubes',catPalaces:'🏰 Palácios',catLimited:'🔥 Limitado',cardLevel:'Nível',cardUpgradeBtn:'Melhorar',cardMaxLevel:'✅ Nível máximo!',cardMiningBonus:'Mineração da Carta',cardUpgradeCost:'Custo de Melhoria',cardWaitTime:'Tempo de Espera',upgrading:'⏳ Melhorando...',upgradeReady:'✅ Pronto',noMining:'⛔ Sem mineração — melhore uma carta!',tasksTitle:'✅ Tarefas',telegramTask:'📱 Entrar no Grupo Telegram',joinGroupBtn:'Entrar →',twitterTask:'🐦 Seguir no Twitter',followTwitterBtn:'Seguir →',getRecord:'Obter 10.000 RECORD',taskDone:'✅ Concluído',inviteTitle:'👥 Convidar',inviteSubtitle:'Convide amigos e ganhe REC!',totalInvited:'Total Convidado',personJoined:'pessoas se juntaram',milestonesTitle:'🎯 Marcos de Recompensa',copyLink:'📋 Copiar Link',shareBtn:'📤 Compartilhar',claimBtn:'Reivindicar! 🎁',inviteN:'Convide {n} pessoas',rankTitle:'🏆 PLACAR',yourLevel:'Seu Nível Atual',yourBalance:'Seu Saldo:',connectWallet:'Conectar Carteira',support:'💬 Suporte @Momokhli',poolWallet:'Carteira Pool',withdrawable:'Saldo disponível',controls:'Controles',withdrawPool:'Retirar Pool',transferPool:'Transferir Pool para Carteira',history:'Histórico',yourWithdrawals:'Seus saques',comingSoon:'Em breve',locked:'Bloqueado',navHome:'Início',navCards:'Cartas',navTasks:'Tarefas',navInvite:'Convidar',navRank:'Ranking',navProfile:'Perfil',toastCopied:'✅ Link copiado!',toastTask:'🎉 Obteve 10.000 RECORD!',toastClaimed:'🎉 Obteve {n} REC!',toastNotMet:'Requisito não atendido!',toastAlready:'Tarefa já concluída!',toastUpgradeStart:'⏳ Melhoria iniciada!',toastUpgradeDone:'🎉 Melhoria concluída!',toastNotEnoughRecord:'RECORD insuficiente!',toastAlreadyUpgrading:'Carta já sendo melhorada!',withdrawalBtn:'Saque',withdrawTitle:'Sacar REC',withdrawSubtitle:'Saque REC para sua carteira',withdrawBalance:'Saldo Disponível',withdrawMin:'Mínimo',withdrawFee:'Taxa',withdrawDaily:'Limite Diário Restante',withdrawAmount:'Valor a sacar',withdrawBtn:'🏛️ Sacar REC Agora',withdrawReceive:'Você receberá:',withdrawAfterFee:'após taxa',withdrawMinErr:'Mínimo {n} REC',withdrawSuccess:'✅ Enviado {n} REC!',withdrawNoWallet:'❌ Conecte carteira TON!',withdrawLowBal:'❌ Saldo insuficiente',withdrawDailyErr:'❌ Limite atingido. Restante: {n} REC',withdrawFailed:'❌ Falha no saque',withdrawLoading:'⏳ Enviando...',tabGlobal:'🌍 Global',tabFriends:'👥 Amigos',tabMyLevel:'📊 Meu Nível',myRankLabel:'Sua Posição Global',weeklyChallenge:'🏆 Desafio Semanal',weeklyPrize:'Prêmio: 1.000 REC',daysLeft:'dias restantes',loadingLeader:'⏳ Carregando...',noFriends:'Você ainda não convidou ninguém',shopTitle:'Loja de Estrelas',shopSubtitle:'Apoie o projeto e ganhe recompensas!',shopNote:'⭐ Estrelas compradas no Telegram',shopEnergy:'⚡ Recarga de Energia Instantânea',shopEnergyDesc:'Recarrega sua energia completamente',shopRecord500:'💰 500.000 RECORD',shopRecord500Desc:'Adicionado instantaneamente',shopRecord3m:'💰 3.000.000 RECORD',shopRecord3mDesc:'Melhor valor ⭐',shopSkip:'🚀 Pular Temporizador',shopSkipDesc:'Conclua melhoria instantaneamente',toastInvoiceLoading:'⏳ Preparando fatura...',toastPaid:'✅ Pagamento bem-sucedido!',toastCancelled:'Pagamento cancelado',toastFailed:'❌ Falha no pagamento',toastConnError:'❌ Erro de conexão',sideDaily:'Diário',sideRank:'Ranking',sideGames:'Jogos',sideCombo:'Combo',sideUpgrade:'Melhorar',sideShop:'Loja',navGames:'Jogos',navWallet:'Carteira',qbTasks:'Tarefas',qbExchange:'Câmbio',qbSwap:'Trocar',recordLabel:'Recorde',recLabel:'REC',energyFull:'Energia Cheia',walletTitle:'Carteira',walletId:'ID',comboTitle:'Combo Diário',comboSubtitle:'Melhore as 3 cartas diárias e ganhe uma recompensa!',comboReward:'Recompensa Diária',comboClaim:'Reivindicar +5 REC 🎉',comboClaimed:'✅ Recompensa reivindicada hoje!',comboLocked:'Nenhum combo hoje',comboAdmin:'Escolher Cartas do Combo - ADMIN',comboSave:'💾 Salvar Combo Diário',totalMined:'Total de REC Minerado',rewardDist:'Distribuição de Recompensas',rankReward:'Recompensa esperada',top100only:'Apenas top 100',sinceJoined:'desde que entrou',dailyRewardTitle:'Recompensa Diária',dailyDay:'Dia {n} / 30',dailyClaimed:'Já reivindicado hoje ✅',dailyComeBack:'Volte amanhã',dailyClaimBtn:'✅ Reivindicado',dailyClaimNow:'Reivindicar Recompensa 🎁',shopEnergyTitle:'Recarga de Energia',shopEnergyRefillLabel:'⚡ Recarga Instantânea',energyRefillTitle:'Recarga de Energia ⚡',energyRefillDesc:'Recarregue sua energia instantaneamente',remainingToday:'Restante hoje:',refillEnergyBtn:'Recarregar Energia ⚡',partnerProgram:'PROGRAMA PARCEIRO',partnerDesc:'Convide amigos e ganhe REC da mineração deles.',commissionRates:'TAXAS DE COMISSÃO',typeLabel:'TIPO',miningLabel:'⛏️ Mineração',blockLabel:'🏆 Bloco',recEarned:'REC GANHO',friendsLabel:'AMIGOS',rewardMilestones:'🎯 MARCOS DE RECOMPENSA',menuSupport:'Suporte',menuNews:'Notícias',menuNewsDesc:'Atualizações e Anúncios',menuChat:'Chat',menuChatDesc:'Chat da Comunidade',menuPayouts:'Pagamentos',menuFaq:'FAQ e Termos',menuFaqDesc:'Regras e Condições',walletAssets:'Ativos',walletControls:'CONTROLES',walletOpen:'Abrir →',walletSoon:'🔒 EM BREVE',recInfoTitle:'⚡ Token REC',recInfoSub:'Como ganhar REC e aumentar a velocidade de mineração',recAutoMining:'Mineração Automática',recAutoMiningDesc:'As cartas de mineração dão REC automaticamente a cada segundo.',recYourSpeed:'Sua velocidade atual:',recCardUpgrade:'Melhorias de Cartas',recCardUpgradeDesc:'Cada melhoria de carta aumenta a velocidade de mineração de REC.',recNormalCard:'Carta Normal',recLimitedCard:'Carta Limitada ⭐',recBlocks:'Blocos',recBlocksDesc:'Cada toque tem chance de encontrar um bloco com grande recompensa de REC!',recDailyCombo:'Combo Diário',recDailyComboDesc:'Melhore as 3 cartas secretas diárias e ganhe +5 REC.',recReferrals:'Referências',recReferralsDesc:'Convide amigos e ganhe comissão da mineração deles:',recTasks:'Tarefas',recTasksDesc:'Complete tarefas sociais e diárias para ganhar REC extra.',recSpeedTip:'💡 Dicas para Aumentar a Velocidade',recTip1:'Melhore cartas limitadas primeiro (×3 velocidade)',recTip2:'Continue melhorando cartas de alto nível',recTip3:'Complete o combo diário todos os dias',recTip4:'Convide amigos para comissão contínua',recordInfoTitle:'🔴 Token RECORD',recordInfoSub:'Como ganhar RECORD e seu papel',recordWhat:'O que é RECORD?',recordWhatSub:'A moeda principal de mineração',recordWhatDesc:'RECORD é a moeda principal do jogo para melhorar cartas e comprar itens.',recordTapping:'Tocando o Círculo',recordTappingSub:'O método mais rápido',recordTappingDesc:'Cada toque no círculo vermelho dá RECORD.',recordTapPower:'Melhorar Tap Power',recordMorePerTap:'↑ RECORD/toque',recordEnergyUp:'Melhorar Energia',recordMoreTaps:'↑ Mais toques',recordAutoMining:'Mineração Automática',recordAutoSub:'Contínuo 24/7',recordAutoDesc:'Cartas minerão RECORD automaticamente mesmo offline.',recordYourSpeed:'Sua velocidade:',recordMystery:'Caixa Misteriosa',recordMysterySub:'Grátis todo dia',recordMysteryDesc:'Abra a caixa misteriosa diária gratuita em Tasks.',recordEnergyRefill:'Recarga de Energia',recordEnergyRefillSub:'Duas vezes por dia grátis',recordEnergyRefillDesc:'Quando a energia acabar, você pode recarregá-la duas vezes por dia.',recordHowSpend:'💡 Como usar RECORD?',recordSpend1:'🃏 Melhorar cartas de mineração',recordSpend2:'⬆️ Melhorar Tap Power',recordSpend3:'⚡ Expandir capacidade de energia',recordSpend4:'⭐ Comprar cartas limitadas na loja',ppCardsUpgraded:'CARTAS MELHORADAS',ppRecSpeed:'VELOCIDADE REC',ppRecord:'RECORD',ppRecBalance:'SALDO REC',ppTotalTaps:'TOTAL DE TOQUES',ppTasksDone:'TAREFAS FEITAS',ppFriends:'AMIGOS',ppCardLevels:'NÍVEIS DAS CARTAS',ppTopCards:'Melhores Cartas',ppNoCards:'Nenhuma carta melhorada',mysteryTitle:'📦 Caixa Misteriosa',mysterySubtitle:'Grátis diariamente — ganhe RECORD ou REC!',mysteryOpenBtn:'Abrir 🎲',mysteryAlready:'Já aberto hoje — volte amanhã!',mysteryYouGot:'Você ganhou:'},
  es:{dir:'ltr',tapMine:'Toca para Minar',energyLabel:'⚡ Energía',miningSpeedLabel:'Minería REC:',recordSpeedLabel:'Minería RECORD:',upgradesTitle:'Mejoras',tapUpgradeTitle:'⚡ Mejora de Toque',energyUpgradeTitle:'🔋 Mejora de Energía',levelLabel:'Nivel:',costLabel:'Costo:',tapsPerClick:'Toques por clic:',totalEnergy:'Energía Total:',upgradeBtn:'Mejorar',backBtn:'← Atrás',cardsTitle:'🃏 Tarjetas',catAnime:'🎌 Anime',catCars:'🚗 Coches',catClubs:'🌙 Clubes',catPalaces:'🏰 Palacios',catLimited:'🔥 Limitado',cardLevel:'Nivel',cardUpgradeBtn:'Mejorar',cardMaxLevel:'✅ ¡Nivel máximo!',cardMiningBonus:'Minería de Tarjeta',cardUpgradeCost:'Costo de Mejora',cardWaitTime:'Tiempo de Espera',upgrading:'⏳ Mejorando...',upgradeReady:'✅ Listo',noMining:'⛔ Sin minería — ¡mejora una tarjeta!',tasksTitle:'✅ Tareas',telegramTask:'📱 Unirse al Grupo Telegram',joinGroupBtn:'Unirse →',twitterTask:'🐦 Seguir en Twitter',followTwitterBtn:'Seguir →',getRecord:'Obtener 10,000 RECORD',taskDone:'✅ Completado',inviteTitle:'👥 Invitar',inviteSubtitle:'¡Invita amigos y gana REC!',totalInvited:'Total Invitado',personJoined:'personas se unieron',milestonesTitle:'🎯 Hitos de Recompensa',copyLink:'📋 Copiar Enlace',shareBtn:'📤 Compartir',claimBtn:'¡Reclamar! 🎁',inviteN:'Invita a {n} personas',rankTitle:'🏆 CLASIFICACIÓN',yourLevel:'Tu Nivel Actual',yourBalance:'Tu Saldo:',connectWallet:'Conectar Billetera',support:'💬 Soporte @Momokhli',poolWallet:'Billetera Pool',withdrawable:'Saldo disponible',controls:'Controles',withdrawPool:'Retirar Pool',transferPool:'Transferir Pool a Billetera',history:'Historial',yourWithdrawals:'Tus retiros',comingSoon:'Próximamente',locked:'Bloqueado',navHome:'Inicio',navCards:'Tarjetas',navTasks:'Tareas',navInvite:'Invitar',navRank:'Ranking',navProfile:'Perfil',toastCopied:'✅ ¡Enlace copiado!',toastTask:'🎉 ¡Obtuviste 10,000 RECORD!',toastClaimed:'🎉 ¡Obtuviste {n} REC!',toastNotMet:'¡Requisito no cumplido!',toastAlready:'¡Tarea ya completada!',toastUpgradeStart:'⏳ ¡Mejora iniciada!',toastUpgradeDone:'🎉 ¡Mejora completada!',toastNotEnoughRecord:'¡RECORD insuficiente!',toastAlreadyUpgrading:'¡Tarjeta ya mejorándose!',withdrawalBtn:'Retiro',withdrawTitle:'Retirar REC',withdrawSubtitle:'Retira REC a tu billetera',withdrawBalance:'Saldo Disponible',withdrawMin:'Mínimo',withdrawFee:'Tarifa',withdrawDaily:'Límite Diario Restante',withdrawAmount:'Cantidad a retirar',withdrawBtn:'🏛️ Retirar REC Ahora',withdrawReceive:'Recibirás:',withdrawAfterFee:'después de tarifa',withdrawMinErr:'Mínimo {n} REC',withdrawSuccess:'✅ ¡Enviado {n} REC!',withdrawNoWallet:'❌ ¡Conecta billetera TON!',withdrawLowBal:'❌ Saldo insuficiente',withdrawDailyErr:'❌ Límite alcanzado. Restante: {n} REC',withdrawFailed:'❌ Error en retiro',withdrawLoading:'⏳ Enviando...',tabGlobal:'🌍 Global',tabFriends:'👥 Amigos',tabMyLevel:'📊 Mi Nivel',myRankLabel:'Tu Rango Global',weeklyChallenge:'🏆 Desafío Semanal',weeklyPrize:'Premio: 1,000 REC',daysLeft:'días restantes',loadingLeader:'⏳ Cargando...',noFriends:'Aún no has invitado a nadie',shopTitle:'Tienda de Estrellas',shopSubtitle:'¡Apoya el proyecto y obtén recompensas!',shopNote:'⭐ Estrellas compradas en Telegram',shopEnergy:'⚡ Recarga de Energía Instantánea',shopEnergyDesc:'Recarga tu energía completamente',shopRecord500:'💰 500,000 RECORD',shopRecord500Desc:'Añadido instantáneamente',shopRecord3m:'💰 3,000,000 RECORD',shopRecord3mDesc:'Mejor valor ⭐',shopSkip:'🚀 Saltar Temporizador',shopSkipDesc:'Completar mejora instantáneamente',toastInvoiceLoading:'⏳ Preparando factura...',toastPaid:'✅ ¡Pago exitoso!',toastCancelled:'Pago cancelado',toastFailed:'❌ Error en el pago',toastConnError:'❌ Error de conexión',sideDaily:'Diario',sideRank:'Ranking',sideGames:'Juegos',sideCombo:'Combo',sideUpgrade:'Mejorar',sideShop:'Tienda',navGames:'Juegos',navWallet:'Billetera',qbTasks:'Tareas',qbExchange:'Intercambio',qbSwap:'Swap',recordLabel:'Récord',recLabel:'REC',energyFull:'Energía Llena',walletTitle:'Billetera',walletId:'ID',comboTitle:'Combo Diario',comboSubtitle:'¡Mejora las 3 cartas diarias y obtén una recompensa!',comboReward:'Recompensa Diaria',comboClaim:'Reclamar +5 REC 🎉',comboClaimed:'✅ ¡Recompensa reclamada hoy!',comboLocked:'Sin combo hoy',comboAdmin:'Elegir Cartas del Combo - ADMIN',comboSave:'💾 Guardar Combo Diario',totalMined:'Total REC Minado',rewardDist:'Distribución de Recompensas',rankReward:'Recompensa esperada',top100only:'Solo top 100',sinceJoined:'desde que entró',dailyRewardTitle:'Recompensa Diaria',dailyDay:'Día {n} / 30',dailyClaimed:'Ya reclamado hoy ✅',dailyComeBack:'Vuelve mañana',dailyClaimBtn:'✅ Reclamado',dailyClaimNow:'Reclamar Recompensa 🎁',shopEnergyTitle:'Recarga de Energía',shopEnergyRefillLabel:'⚡ Recarga Instantánea',energyRefillTitle:'Recarga de Energía ⚡',energyRefillDesc:'Recarga tu energía al instante',remainingToday:'Restante hoy:',refillEnergyBtn:'Recargar Energía ⚡',partnerProgram:'PROGRAMA DE SOCIOS',partnerDesc:'Invita amigos y gana REC de su minería.',commissionRates:'TASAS DE COMISIÓN',typeLabel:'TIPO',miningLabel:'⛏️ Minería',blockLabel:'🏆 Bloque',recEarned:'REC GANADO',friendsLabel:'AMIGOS',rewardMilestones:'🎯 HITOS DE RECOMPENSA',menuSupport:'Soporte',menuNews:'Noticias',menuNewsDesc:'Actualizaciones y Anuncios',menuChat:'Chat',menuChatDesc:'Chat de la Comunidad',menuPayouts:'Pagos',menuFaq:'FAQ y Términos',menuFaqDesc:'Reglas y Condiciones',walletAssets:'Activos',walletControls:'CONTROLES',walletOpen:'Abrir →',walletSoon:'🔒 PRONTO',recInfoTitle:'⚡ Token REC',recInfoSub:'Cómo ganar REC y aumentar la velocidad de minería',recAutoMining:'Minería Automática',recAutoMiningDesc:'Las cartas de minería te dan REC automáticamente cada segundo.',recYourSpeed:'Tu velocidad actual:',recCardUpgrade:'Mejoras de Tarjetas',recCardUpgradeDesc:'Cada mejora de tarjeta aumenta la velocidad de minería de REC.',recNormalCard:'Tarjeta Normal',recLimitedCard:'Tarjeta Limitada ⭐',recBlocks:'Bloques',recBlocksDesc:'¡Cada toque tiene oportunidad de encontrar un bloque con gran recompensa de REC!',recDailyCombo:'Combo Diario',recDailyComboDesc:'Mejora las 3 cartas secretas diarias y obtén +5 REC.',recReferrals:'Referencias',recReferralsDesc:'Invita amigos y gana comisión de su minería:',recTasks:'Tareas',recTasksDesc:'Completa tareas sociales y diarias para ganar REC adicional.',recSpeedTip:'💡 Consejos para Aumentar la Velocidad',recTip1:'Mejora cartas limitadas primero (×3 velocidad)',recTip2:'Continúa mejorando cartas de alto nivel',recTip3:'Completa el combo diario cada día',recTip4:'Invita amigos para comisión continua',recordInfoTitle:'🔴 Token RECORD',recordInfoSub:'Cómo ganar RECORD y su rol',recordWhat:'¿Qué es RECORD?',recordWhatSub:'La moneda principal de minería',recordWhatDesc:'RECORD es la moneda principal del juego para mejorar tarjetas y comprar items.',recordTapping:'Tocando el Círculo',recordTappingSub:'El método más rápido',recordTappingDesc:'Cada toque en el círculo rojo da RECORD.',recordTapPower:'Mejorar Tap Power',recordMorePerTap:'↑ RECORD/toque',recordEnergyUp:'Mejorar Energía',recordMoreTaps:'↑ Más toques',recordAutoMining:'Minería Automática',recordAutoSub:'Continuo 24/7',recordAutoDesc:'Las cartas minan RECORD automáticamente incluso offline.',recordYourSpeed:'Tu velocidad:',recordMystery:'Caja Misteriosa',recordMysterySub:'Gratis cada día',recordMysteryDesc:'Abre la caja misteriosa diaria gratuita en Tasks.',recordEnergyRefill:'Recarga de Energía',recordEnergyRefillSub:'Dos veces al día gratis',recordEnergyRefillDesc:'Cuando se acaba la energía puedes recargarla dos veces al día.',recordHowSpend:'💡 ¿Cómo usar RECORD?',recordSpend1:'🃏 Mejorar cartas de minería',recordSpend2:'⬆️ Mejorar Tap Power',recordSpend3:'⚡ Expandir capacidad de energía',recordSpend4:'⭐ Comprar cartas limitadas en la tienda',ppCardsUpgraded:'CARTAS MEJORADAS',ppRecSpeed:'VELOCIDAD REC',ppRecord:'RECORD',ppRecBalance:'BALANCE REC',ppTotalTaps:'TOTAL DE TOQUES',ppTasksDone:'TAREAS HECHAS',ppFriends:'AMIGOS',ppCardLevels:'NIVELES DE CARTAS',ppTopCards:'Mejores Tarjetas',ppNoCards:'Sin cartas mejoradas aún',mysteryTitle:'📦 Caja Misteriosa',mysterySubtitle:'¡Gratis diariamente — gana RECORD o REC!',mysteryOpenBtn:'Abrir 🎲',mysteryAlready:'¡Ya abierto hoy — vuelve mañana!',mysteryYouGot:'Obtuviste:'},
  tr:{dir:'ltr',tapMine:'Madencilik İçin Dokun',energyLabel:'⚡ Enerji',miningSpeedLabel:'REC Madenciliği:',recordSpeedLabel:'RECORD Madenciliği:',upgradesTitle:'Yükseltmeler',tapUpgradeTitle:'⚡ Dokunma Yükseltmesi',energyUpgradeTitle:'🔋 Enerji Yükseltmesi',levelLabel:'Seviye:',costLabel:'Maliyet:',tapsPerClick:'Tıklama başına dokunuş:',totalEnergy:'Toplam Enerji:',upgradeBtn:'Yükselt',backBtn:'← Geri',cardsTitle:'🃏 Kartlar',catAnime:'🎌 Anime',catCars:'🚗 Arabalar',catClubs:'🌙 Kulüpler',catPalaces:'🏰 Saraylar',catLimited:'🔥 Sınırlı',cardLevel:'Seviye',cardUpgradeBtn:'Yükselt',cardMaxLevel:'✅ Maksimum seviye!',cardMiningBonus:'Kart Madenciliği',cardUpgradeCost:'Yükseltme Maliyeti',cardWaitTime:'Bekleme Süresi',upgrading:'⏳ Yükseltiliyor...',upgradeReady:'✅ Hazır',noMining:'⛔ Madencilik yok — önce bir kart yükselt!',tasksTitle:'✅ Görevler',telegramTask:'📱 Telegram Grubuna Katıl',joinGroupBtn:'Katıl →',twitterTask:'🐦 Twitter\'da Takip Et',followTwitterBtn:'Takip Et →',getRecord:'10.000 RECORD Al',taskDone:'✅ Tamamlandı',inviteTitle:'👥 Davet Et',inviteSubtitle:'Arkadaşlarını davet et ve REC kazan!',totalInvited:'Toplam Davet',personJoined:'kişi katıldı',milestonesTitle:'🎯 Ödül Dönüm Noktaları',copyLink:'📋 Bağlantıyı Kopyala',shareBtn:'📤 Paylaş',claimBtn:'Al! 🎁',inviteN:'{n} kişi davet et',rankTitle:'🏆 LIDERBOARD',yourLevel:'Mevcut Seviyeniz',yourBalance:'Bakiyeniz:',connectWallet:'Cüzdan Bağla',support:'💬 Destek @Momokhli',poolWallet:'Pool Cüzdan',withdrawable:'Çekilebilir bakiye',controls:'Kontroller',withdrawPool:'Pool Çek',transferPool:'Pool\'u Cüzdana Transfer Et',history:'Geçmiş',yourWithdrawals:'Çekimleriniz',comingSoon:'Yakında',locked:'Kilitli',navHome:'Ana Sayfa',navCards:'Kartlar',navTasks:'Görevler',navInvite:'Davet Et',navRank:'Sıralama',navProfile:'Profil',toastCopied:'✅ Bağlantı kopyalandı!',toastTask:'🎉 10.000 RECORD kazandın!',toastClaimed:'🎉 {n} REC kazandın!',toastNotMet:'Gereksinim karşılanmadı!',toastAlready:'Görev zaten tamamlandı!',toastUpgradeStart:'⏳ Kart yükseltmesi başladı!',toastUpgradeDone:'🎉 Yükseltme tamamlandı!',toastNotEnoughRecord:'Yetersiz RECORD!',toastAlreadyUpgrading:'Kart zaten yükseltiliyor!',withdrawalBtn:'Çekim',withdrawTitle:'REC Çek',withdrawSubtitle:'REC\'i cüzdanına çek',withdrawBalance:'Kullanılabilir Bakiye',withdrawMin:'Minimum',withdrawFee:'Ücret',withdrawDaily:'Günlük Kalan Limit',withdrawAmount:'Çekilecek Miktar',withdrawBtn:'🏛️ REC Çek',withdrawReceive:'Alacaksınız:',withdrawAfterFee:'ücret sonrası',withdrawMinErr:'Minimum {n} REC',withdrawSuccess:'✅ {n} REC gönderildi!',withdrawNoWallet:'❌ TON cüzdanı bağlayın!',withdrawLowBal:'❌ Yetersiz bakiye',withdrawDailyErr:'❌ Günlük limit. Kalan: {n} REC',withdrawFailed:'❌ Çekim başarısız',withdrawLoading:'⏳ Gönderiliyor...',tabGlobal:'🌍 Global',tabFriends:'👥 Arkadaşlar',tabMyLevel:'📊 Seviyem',myRankLabel:'Global Sıralamanız',weeklyChallenge:'🏆 Haftalık Meydan Okuma',weeklyPrize:'Ödül: 1.000 REC',daysLeft:'gün kaldı',loadingLeader:'⏳ Yükleniyor...',noFriends:'Henüz kimseyi davet etmediniz',shopTitle:'Yıldız Mağazası',shopSubtitle:'Projeyi destekle ve ödül kazan!',shopNote:'⭐ Yıldızlar Telegram\'dan satın alınır',shopEnergy:'⚡ Anlık Enerji Doldurma',shopEnergyDesc:'Enerjini tamamen doldurur',shopRecord500:'💰 500.000 RECORD',shopRecord500Desc:'Bakiyeye anında eklenir',shopRecord3m:'💰 3.000.000 RECORD',shopRecord3mDesc:'En iyi değer ⭐',shopSkip:'🚀 Beklemeyi Atla',shopSkipDesc:'Kart yükseltmesini anında tamamla',toastInvoiceLoading:'⏳ Fatura hazırlanıyor...',toastPaid:'✅ Ödeme başarılı!',toastCancelled:'Ödeme iptal edildi',toastFailed:'❌ Ödeme başarısız',toastConnError:'❌ Bağlantı hatası',sideDaily:'Günlük',sideRank:'Sıralama',sideGames:'Oyunlar',sideCombo:'Kombo',sideUpgrade:'Yükselt',sideShop:'Mağaza',navGames:'Oyunlar',navWallet:'Cüzdan',qbTasks:'Görevler',qbExchange:'Borsa',qbSwap:'Takas',recordLabel:'Rekor',recLabel:'REC',energyFull:'Tam Enerji',walletTitle:'Cüzdan',walletId:'ID',comboTitle:'Günlük Kombo',comboSubtitle:'3 günlük kartı yükselt ve ödül kazan!',comboReward:'Günlük Ödül',comboClaim:'+5 REC Al 🎉',comboClaimed:'✅ Bugün ödül alındı!',comboLocked:'Bugün kombo yok',comboAdmin:'Kombo Kartlarını Seç - ADMIN',comboSave:'💾 Günlük Komboyu Kaydet',totalMined:'Toplam Kazılan REC',rewardDist:'Ödül Dağılımı',rankReward:'Beklenen ödül',top100only:'Yalnızca ilk 100',sinceJoined:'katıldığından beri',dailyRewardTitle:'Günlük Ödül',dailyDay:'Gün {n} / 30',dailyClaimed:'Bugün alındı ✅',dailyComeBack:'Yarın gelin',dailyClaimBtn:'✅ Alındı',dailyClaimNow:'Ödülü Al 🎁',shopEnergyTitle:'Enerji Yükleme',shopEnergyRefillLabel:'⚡ Anlık Şarj',energyRefillTitle:'Enerji Şarjı ⚡',energyRefillDesc:'Enerjini anında doldur',remainingToday:'Bugün kalan:',refillEnergyBtn:'Enerji Şarj Et ⚡',partnerProgram:'ORTAK PROGRAMI',partnerDesc:'Arkadaşlarını davet et ve onların madenciliğinden REC kazan.',commissionRates:'KOMİSYON ORANLARI',typeLabel:'TÜR',miningLabel:'⛏️ Madencilik',blockLabel:'🏆 Blok',recEarned:'KAZANILAN REC',friendsLabel:'ARKADAŞLAR',rewardMilestones:'🎯 ÖDÜL AŞAMALARI',menuSupport:'Destek',menuNews:'Haberler',menuNewsDesc:'Güncellemeler ve Duyurular',menuChat:'Sohbet',menuChatDesc:'Topluluk Sohbeti',menuPayouts:'Ödemeler',menuFaq:'SSS ve Koşullar',menuFaqDesc:'Kurallar ve Koşullar',walletAssets:'Varlıklar',walletControls:'KONTROLLER',walletOpen:'Aç →',walletSoon:'🔒 YAKINDA',recInfoTitle:'⚡ REC Tokeni',recInfoSub:'REC nasıl kazanılır ve madencilik hızı nasıl artırılır',recAutoMining:'Otomatik Madencilik',recAutoMiningDesc:'Madencilik kartları her saniye otomatik olarak REC verir.',recYourSpeed:'Mevcut hızınız:',recCardUpgrade:'Kart Yükseltmeleri',recCardUpgradeDesc:'Her kart yükseltmesi REC madencilik hızını artırır.',recNormalCard:'Normal Kart',recLimitedCard:'Sınırlı Kart ⭐',recBlocks:'Bloklar',recBlocksDesc:'Her dokunuşun büyük bir REC ödülü kazanma şansı var!',recDailyCombo:'Günlük Kombo',recDailyComboDesc:'3 günlük gizli kartı yükselt ve +5 REC kazan.',recReferrals:'Referanslar',recReferralsDesc:'Arkadaşlarını davet et ve madenciliklerinden komisyon kazan:',recTasks:'Görevler',recTasksDesc:'Ekstra REC için sosyal ve günlük görevleri tamamla.',recSpeedTip:'💡 Hız Artırma İpuçları',recTip1:'Önce sınırlı kartları yükselt (×3 hız)',recTip2:'Yüksek seviyeli kartları yükseltmeye devam et',recTip3:'Her gün günlük komboyu tamamla',recTip4:'Sürekli komisyon için arkadaşlarını davet et',recordInfoTitle:'🔴 RECORD Tokeni',recordInfoSub:'RECORD nasıl kazanılır ve rolü',recordWhat:'RECORD nedir?',recordWhatSub:'Ana madencilik para birimi',recordWhatDesc:'RECORD, kartları yükseltmek ve eşya satın almak için kullanılan ana para birimidir.',recordTapping:'Daireye Dokunma',recordTappingSub:'En hızlı yöntem',recordTappingDesc:'Kırmızı daireye her dokunuş RECORD verir.',recordTapPower:'Tap Power Yükselt',recordMorePerTap:'↑ RECORD/dokunuş',recordEnergyUp:'Enerji Yükselt',recordMoreTaps:'↑ Daha fazla dokunuş',recordAutoMining:'Otomatik Madencilik',recordAutoSub:'Sürekli 24/7',recordAutoDesc:'Kartlar çevrimdışıyken bile otomatik RECORD kazandırır.',recordYourSpeed:'Hızınız:',recordMystery:'Gizemli Kutu',recordMysterySub:'Her gün ücretsiz',recordMysteryDesc:'Tasks bölümünden ücretsiz günlük gizemli kutuyu aç.',recordEnergyRefill:'Enerji Şarjı',recordEnergyRefillSub:'Günde iki kez ücretsiz',recordEnergyRefillDesc:'Enerjin bittiğinde günde iki kez ücretsiz doldurabilirsin.',recordHowSpend:'💡 RECORD nasıl kullanılır?',recordSpend1:'🃏 Madencilik kartlarını yükselt',recordSpend2:'⬆️ Tap Power yükselt',recordSpend3:'⚡ Enerji kapasitesini genişlet',recordSpend4:'⭐ Mağazadan sınırlı kartlar satın al',ppCardsUpgraded:'YÜKSELTİLEN KART',ppRecSpeed:'REC HIZI',ppRecord:'RECORD',ppRecBalance:'REC BAKİYE',ppTotalTaps:'TOPLAM DOKUNUŞ',ppTasksDone:'TAMAMLANAN GÖREV',ppFriends:'ARKADAŞLAR',ppCardLevels:'KART SEVİYELERİ',ppTopCards:'En İyi Kartlar',ppNoCards:'Henüz yükseltilmiş kart yok',mysteryTitle:'📦 Gizemli Kutu',mysterySubtitle:'Her gün ücretsiz — RECORD veya REC kazan!',mysteryOpenBtn:'Aç 🎲',mysteryAlready:'Bugün zaten açıldı — yarın gel!',mysteryYouGot:'Aldınız:'},
  vi:{dir:'ltr',tapMine:'Nhấn để Khai Thác',energyLabel:'⚡ Năng lượng',miningSpeedLabel:'Khai thác REC:',recordSpeedLabel:'Khai thác RECORD:',upgradesTitle:'Nâng cấp',tapUpgradeTitle:'⚡ Nâng cấp chạm',energyUpgradeTitle:'🔋 Nâng cấp năng lượng',levelLabel:'Cấp độ:',costLabel:'Chi phí:',tapsPerClick:'Lần chạm mỗi cú nhấp:',totalEnergy:'Tổng năng lượng:',upgradeBtn:'Nâng cấp',backBtn:'← Quay lại',cardsTitle:'🃏 Thẻ bài',catAnime:'🎌 Anime',catCars:'🚗 Xe hơi',catClubs:'🌙 Câu lạc bộ',catPalaces:'🏰 Cung điện',catLimited:'🔥 Giới hạn',cardLevel:'Cấp độ',cardUpgradeBtn:'Nâng cấp',cardMaxLevel:'✅ Cấp độ tối đa!',cardMiningBonus:'Khai thác thẻ',cardUpgradeCost:'Chi phí nâng cấp',cardWaitTime:'Thời gian chờ',upgrading:'⏳ Đang nâng cấp...',upgradeReady:'✅ Sẵn sàng',noMining:'⛔ Không có khai thác — nâng cấp thẻ trước!',tasksTitle:'✅ Nhiệm vụ',telegramTask:'📱 Tham gia nhóm Telegram',joinGroupBtn:'Tham gia →',twitterTask:'🐦 Theo dõi Twitter',followTwitterBtn:'Theo dõi →',getRecord:'Nhận 10,000 RECORD',taskDone:'✅ Hoàn thành',inviteTitle:'👥 Mời bạn bè',inviteSubtitle:'Mời bạn bè và kiếm REC!',totalInvited:'Tổng số đã mời',personJoined:'người đã tham gia',milestonesTitle:'🎯 Cột mốc phần thưởng',copyLink:'📋 Sao chép liên kết',shareBtn:'📤 Chia sẻ',claimBtn:'Nhận! 🎁',inviteN:'Mời {n} người',rankTitle:'🏆 BẢNG XẾP HẠNG',yourLevel:'Cấp độ hiện tại',yourBalance:'Số dư:',connectWallet:'Kết nối Ví',support:'💬 Hỗ trợ @Momokhli',poolWallet:'Ví Pool',withdrawable:'Số dư có thể rút',controls:'Điều khiển',withdrawPool:'Rút Pool',transferPool:'Chuyển Pool vào Ví',history:'Lịch sử',yourWithdrawals:'Lịch sử rút tiền',comingSoon:'Sắp có',locked:'Đã khóa',navHome:'Trang chủ',navCards:'Thẻ bài',navTasks:'Nhiệm vụ',navInvite:'Mời bạn',navRank:'Xếp hạng',navProfile:'Hồ sơ',toastCopied:'✅ Đã sao chép liên kết!',toastTask:'🎉 Nhận được 10,000 RECORD!',toastClaimed:'🎉 Nhận được {n} REC!',toastNotMet:'Yêu cầu chưa đáp ứng!',toastAlready:'Nhiệm vụ đã hoàn thành!',toastUpgradeStart:'⏳ Bắt đầu nâng cấp thẻ!',toastUpgradeDone:'🎉 Nâng cấp hoàn thành!',toastNotEnoughRecord:'Không đủ RECORD!',toastAlreadyUpgrading:'Thẻ đang được nâng cấp!',withdrawalBtn:'Rút tiền',withdrawTitle:'Rút REC',withdrawSubtitle:'Rút REC vào ví của bạn',withdrawBalance:'Số dư khả dụng',withdrawMin:'Tối thiểu',withdrawFee:'Phí',withdrawDaily:'Hạn mức ngày còn lại',withdrawAmount:'Số tiền rút',withdrawBtn:'🏛️ Rút REC Ngay',withdrawReceive:'Bạn sẽ nhận:',withdrawAfterFee:'sau phí',withdrawMinErr:'Tối thiểu {n} REC',withdrawSuccess:'✅ Đã gửi {n} REC!',withdrawNoWallet:'❌ Kết nối ví TON trước!',withdrawLowBal:'❌ Số dư không đủ',withdrawDailyErr:'❌ Đạt giới hạn ngày. Còn lại: {n} REC',withdrawFailed:'❌ Rút tiền thất bại',withdrawLoading:'⏳ Đang gửi...',tabGlobal:'🌍 Toàn cầu',tabFriends:'👥 Bạn bè',tabMyLevel:'📊 Cấp độ của tôi',myRankLabel:'Thứ hạng toàn cầu',weeklyChallenge:'🏆 Thách thức hàng tuần',weeklyPrize:'Giải thưởng: 1,000 REC',daysLeft:'ngày còn lại',loadingLeader:'⏳ Đang tải...',noFriends:'Bạn chưa mời ai',shopTitle:'Cửa hàng Sao',shopSubtitle:'Ủng hộ dự án và nhận phần thưởng!',shopNote:'⭐ Sao mua trực tiếp từ Telegram',shopEnergy:'⚡ Nạp năng lượng ngay',shopEnergyDesc:'Khôi phục đầy đủ năng lượng',shopRecord500:'💰 500,000 RECORD',shopRecord500Desc:'Thêm ngay vào số dư',shopRecord3m:'💰 3,000,000 RECORD',shopRecord3mDesc:'Giá trị tốt nhất ⭐',shopSkip:'🚀 Bỏ qua thời gian chờ',shopSkipDesc:'Hoàn thành nâng cấp thẻ ngay',toastInvoiceLoading:'⏳ Đang chuẩn bị hóa đơn...',toastPaid:'✅ Thanh toán thành công!',toastCancelled:'Đã hủy thanh toán',toastFailed:'❌ Thanh toán thất bại',toastConnError:'❌ Lỗi kết nối',sideDaily:'Hàng ngày',sideRank:'Xếp hạng',sideGames:'Trò chơi',sideCombo:'Combo',sideUpgrade:'Nâng cấp',sideShop:'Cửa hàng',navGames:'Trò chơi',navWallet:'Ví',qbTasks:'Nhiệm vụ',qbExchange:'Đổi',qbSwap:'Hoán đổi',recordLabel:'Kỷ lục',recLabel:'REC',energyFull:'Đầy năng lượng',walletTitle:'Ví',walletId:'ID',comboTitle:'Combo Hàng Ngày',comboSubtitle:'Nâng cấp 3 thẻ hàng ngày và nhận phần thưởng!',comboReward:'Phần thưởng hàng ngày',comboClaim:'Nhận +5 REC 🎉',comboClaimed:'✅ Đã nhận phần thưởng hôm nay!',comboLocked:'Chưa có combo hôm nay',comboAdmin:'Chọn thẻ Combo - ADMIN',comboSave:'💾 Lưu Combo Hàng Ngày',totalMined:'Tổng REC đã đào',rewardDist:'Phân phối phần thưởng',rankReward:'Phần thưởng dự kiến',top100only:'Chỉ top 100',sinceJoined:'kể từ khi tham gia',dailyRewardTitle:'Phần Thưởng Hàng Ngày',dailyDay:'Ngày {n} / 30',dailyClaimed:'Đã nhận hôm nay ✅',dailyComeBack:'Quay lại ngày mai',dailyClaimBtn:'✅ Đã nhận',dailyClaimNow:'Nhận Phần Thưởng 🎁',shopEnergyTitle:'Nạp Năng Lượng',shopEnergyRefillLabel:'⚡ Nạp Ngay',energyRefillTitle:'Nạp Năng Lượng ⚡',energyRefillDesc:'Nạp đầy năng lượng ngay lập tức',remainingToday:'Còn lại hôm nay:',refillEnergyBtn:'Nạp Năng Lượng ⚡',partnerProgram:'CHƯƠNG TRÌNH ĐỐI TÁC',partnerDesc:'Mời bạn bè và kiếm REC từ việc khai thác của họ.',commissionRates:'TỶ LỆ HOA HỒNG',typeLabel:'LOẠI',miningLabel:'⛏️ Khai thác',blockLabel:'🏆 Khối',recEarned:'REC KIẾM ĐƯỢC',friendsLabel:'BẠN BÈ',rewardMilestones:'🎯 CỘT MỐC PHẦN THƯỞNG',menuSupport:'Hỗ trợ',menuNews:'Tin tức',menuNewsDesc:'Cập nhật & Thông báo',menuChat:'Trò chuyện',menuChatDesc:'Trò chuyện cộng đồng',menuPayouts:'Thanh toán',menuFaq:'FAQ & Điều khoản',menuFaqDesc:'Quy tắc & Điều kiện',walletAssets:'Tài sản',walletControls:'ĐIỀU KHIỂN',walletOpen:'Mở →',walletSoon:'🔒 SẮP CÓ',recInfoTitle:'⚡ Token REC',recInfoSub:'Cách kiếm REC và tăng tốc độ khai thác',recAutoMining:'Khai thác tự động',recAutoMiningDesc:'Thẻ khai thác tự động cho bạn REC mỗi giây.',recYourSpeed:'Tốc độ hiện tại của bạn:',recCardUpgrade:'Nâng cấp thẻ',recCardUpgradeDesc:'Mỗi lần nâng cấp thẻ tăng tốc độ khai thác REC.',recNormalCard:'Thẻ thường',recLimitedCard:'Thẻ giới hạn ⭐',recBlocks:'Khối',recBlocksDesc:'Mỗi lần nhấn có cơ hội tìm thấy một khối với phần thưởng REC lớn!',recDailyCombo:'Combo Hàng Ngày',recDailyComboDesc:'Nâng cấp 3 thẻ bí mật hàng ngày và nhận +5 REC.',recReferrals:'Giới thiệu',recReferralsDesc:'Mời bạn bè và kiếm hoa hồng từ việc khai thác của họ:',recTasks:'Nhiệm vụ',recTasksDesc:'Hoàn thành các nhiệm vụ xã hội và hàng ngày để nhận REC thêm.',recSpeedTip:'💡 Mẹo tăng tốc độ',recTip1:'Nâng cấp thẻ giới hạn trước (×3 tốc độ)',recTip2:'Tiếp tục nâng cấp thẻ cấp cao',recTip3:'Hoàn thành combo hàng ngày mỗi ngày',recTip4:'Mời bạn bè để có hoa hồng liên tục',recordInfoTitle:'🔴 Token RECORD',recordInfoSub:'Cách kiếm RECORD và vai trò của nó',recordWhat:'RECORD là gì?',recordWhatSub:'Tiền tệ khai thác chính',recordWhatDesc:'RECORD là tiền tệ chính trong game để nâng cấp thẻ và mua vật phẩm.',recordTapping:'Nhấn vào vòng tròn',recordTappingSub:'Phương pháp nhanh nhất',recordTappingDesc:'Mỗi lần nhấn vào vòng tròn đỏ cho RECORD.',recordTapPower:'Nâng cấp Tap Power',recordMorePerTap:'↑ RECORD/lần nhấn',recordEnergyUp:'Nâng cấp năng lượng',recordMoreTaps:'↑ Nhiều lần nhấn hơn',recordAutoMining:'Khai thác tự động',recordAutoSub:'Liên tục 24/7',recordAutoDesc:'Thẻ tự động khai thác RECORD ngay cả khi offline.',recordYourSpeed:'Tốc độ của bạn:',recordMystery:'Hộp Bí Ẩn',recordMysterySub:'Miễn phí mỗi ngày',recordMysteryDesc:'Mở hộp bí ẩn miễn phí hàng ngày từ Tasks.',recordEnergyRefill:'Nạp năng lượng',recordEnergyRefillSub:'Miễn phí hai lần mỗi ngày',recordEnergyRefillDesc:'Khi năng lượng hết, bạn có thể nạp lại miễn phí hai lần mỗi ngày.',recordHowSpend:'💡 Cách sử dụng RECORD?',recordSpend1:'🃏 Nâng cấp thẻ khai thác',recordSpend2:'⬆️ Nâng cấp Tap Power',recordSpend3:'⚡ Mở rộng dung lượng năng lượng',recordSpend4:'⭐ Mua thẻ giới hạn từ cửa hàng',ppCardsUpgraded:'THẺ NÂNG CẤP',ppRecSpeed:'TỐC ĐỘ REC',ppRecord:'RECORD',ppRecBalance:'SỐ DƯ REC',ppTotalTaps:'TỔNG LẦN NHẤN',ppTasksDone:'NHIỆM VỤ HOÀN THÀNH',ppFriends:'BẠN BÈ',ppCardLevels:'CẤP ĐỘ THẺ',ppTopCards:'Thẻ hàng đầu',ppNoCards:'Chưa có thẻ nào được nâng cấp',mysteryTitle:'📦 Hộp Bí Ẩn',mysterySubtitle:'Miễn phí hàng ngày — thắng RECORD hoặc REC!',mysteryOpenBtn:'Mở 🎲',mysteryAlready:'Đã mở hôm nay — quay lại ngày mai!',mysteryYouGot:'Bạn nhận được:'},
  zh:{dir:'ltr',tapMine:'点击挖矿',energyLabel:'⚡ 能量',miningSpeedLabel:'REC挖矿:',recordSpeedLabel:'RECORD挖矿:',upgradesTitle:'升级',tapUpgradeTitle:'⚡ 点击升级',energyUpgradeTitle:'🔋 能量升级',levelLabel:'等级:',costLabel:'费用:',tapsPerClick:'每次点击次数:',totalEnergy:'总能量:',upgradeBtn:'升级',backBtn:'← 返回',cardsTitle:'🃏 卡片',catAnime:'🎌 动漫',catCars:'🚗 汽车',catClubs:'🌙 夜总会',catPalaces:'🏰 宫殿',catLimited:'🔥 限定',cardLevel:'等级',cardUpgradeBtn:'升级',cardMaxLevel:'✅ 已达最高等级!',cardMiningBonus:'卡片挖矿',cardUpgradeCost:'升级费用',cardWaitTime:'等待时间',upgrading:'⏳ 升级中...',upgradeReady:'✅ 就绪',noMining:'⛔ 无挖矿 — 请先升级卡片!',tasksTitle:'✅ 任务',telegramTask:'📱 加入Telegram群组',joinGroupBtn:'加入群组 →',twitterTask:'🐦 在推特关注',followTwitterBtn:'在推特关注 →',getRecord:'获得 10,000 RECORD',taskDone:'✅ 已完成',inviteTitle:'👥 邀请',inviteSubtitle:'邀请朋友赚取REC!',totalInvited:'总邀请人数',personJoined:'人加入',milestonesTitle:'🎯 奖励里程碑',copyLink:'📋 复制链接',shareBtn:'📤 分享',claimBtn:'领取! 🎁',inviteN:'邀请{n}人',rankTitle:'🏆 排行榜',yourLevel:'您的当前级别',yourBalance:'您的余额:',connectWallet:'连接钱包',support:'💬 技术支持 @Momokhli',poolWallet:'Pool钱包',withdrawable:'可提现余额',controls:'操作',withdrawPool:'提取Pool',transferPool:'将Pool转入钱包',history:'历史',yourWithdrawals:'提现记录',comingSoon:'即将推出',locked:'已锁定',navHome:'首页',navCards:'卡片',navTasks:'任务',navInvite:'邀请',navRank:'排名',navProfile:'个人',toastCopied:'✅ 链接已复制!',toastTask:'🎉 获得10,000 RECORD!',toastClaimed:'🎉 获得{n} REC!',toastNotMet:'尚未满足要求!',toastAlready:'任务已完成!',toastUpgradeStart:'⏳ 卡片升级开始!',toastUpgradeDone:'🎉 升级完成!',toastNotEnoughRecord:'RECORD不足!',toastAlreadyUpgrading:'卡片升级中!',withdrawalBtn:'提现',withdrawTitle:'提取REC',withdrawSubtitle:'提取真实REC到钱包',withdrawBalance:'可用余额',withdrawMin:'最低',withdrawFee:'手续费',withdrawDaily:'今日剩余额度',withdrawAmount:'提现金额',withdrawBtn:'🏛️ 立即提取REC',withdrawReceive:'您将收到:',withdrawAfterFee:'扣除手续费后',withdrawMinErr:'最低{n} REC',withdrawSuccess:'✅ 已发送{n} REC!',withdrawNoWallet:'❌ 请先连接TON钱包!',withdrawLowBal:'❌ 余额不足',withdrawDailyErr:'❌ 已达日限额。剩余: {n} REC',withdrawFailed:'❌ 提现失败',withdrawLoading:'⏳ 发送中...',tabGlobal:'🌍 全球',tabFriends:'👥 好友',tabMyLevel:'📊 我的等级',myRankLabel:'您的全球排名',weeklyChallenge:'🏆 每周挑战',weeklyPrize:'奖励: 1,000 REC',daysLeft:'天剩余',loadingLeader:'⏳ 加载中...',noFriends:'您还没有邀请任何人',shopTitle:'星星商店',shopSubtitle:'支持项目并获得即时奖励!',shopNote:'⭐ 星星直接从Telegram购买',shopEnergy:'⚡ 即时能量补充',shopEnergyDesc:'完全补充您的能量',shopRecord500:'💰 500,000 RECORD',shopRecord500Desc:'立即添加到余额',shopRecord3m:'💰 3,000,000 RECORD',shopRecord3mDesc:'最佳价值 ⭐',shopSkip:'🚀 跳过等待时间',shopSkipDesc:'立即完成卡片升级',toastInvoiceLoading:'⏳ 准备发票...',toastPaid:'✅ 支付成功!',toastCancelled:'已取消支付',toastFailed:'❌ 支付失败',toastConnError:'❌ 连接错误',comboLocked:'今天没有组合',comboAdmin:'选择组合卡片 - ADMIN',comboSave:'💾 保存每日组合',totalMined:'已挖REC总量',rewardDist:'奖励分配',rankReward:'预计奖励',top100only:'仅前100名',sinceJoined:'自加入以来',dailyRewardTitle:'每日奖励',dailyDay:'第 {n} 天 / 30',dailyClaimed:'今天已领取 ✅',dailyComeBack:'明天再来',dailyClaimBtn:'✅ 已领取',dailyClaimNow:'领取奖励 🎁',shopEnergyTitle:'能量充值',shopEnergyRefillLabel:'⚡ 即时充能',energyRefillTitle:'能量充值 ⚡',energyRefillDesc:'立即补充能量',remainingToday:'今日剩余:',refillEnergyBtn:'充能 ⚡',partnerProgram:'合作伙伴计划',partnerDesc:'邀请朋友，从他们的挖矿中赚取REC。',commissionRates:'佣金率',typeLabel:'类型',miningLabel:'⛏️ 挖矿',blockLabel:'🏆 区块',recEarned:'已赚取REC',friendsLabel:'朋友',rewardMilestones:'🎯 奖励里程碑',menuSupport:'支持',menuNews:'新闻',menuNewsDesc:'更新和公告',menuChat:'聊天',menuChatDesc:'社区聊天',menuPayouts:'支付',menuFaq:'FAQ和条款',menuFaqDesc:'规则和条件',walletAssets:'资产',walletControls:'操作',walletOpen:'打开 →',walletSoon:'🔒 即将',recInfoTitle:'⚡ REC代币',recInfoSub:'如何赚取REC并提高挖矿速度',recAutoMining:'自动挖矿',recAutoMiningDesc:'挖矿卡每秒自动给你REC。',recYourSpeed:'您当前速度:',recCardUpgrade:'卡片升级',recCardUpgradeDesc:'每次卡片升级都会提高REC挖矿速度。',recNormalCard:'普通卡',recLimitedCard:'限定卡 ⭐',recBlocks:'区块',recBlocksDesc:'每次点击都有机会找到一个区块，获得大量REC奖励！',recDailyCombo:'每日组合',recDailyComboDesc:'升级3张每日秘密卡片，获得+5 REC奖励。',recReferrals:'推荐',recReferralsDesc:'邀请朋友，从他们的挖矿中赚取佣金:',recTasks:'任务',recTasksDesc:'完成社交和每日任务以获得额外REC。',recSpeedTip:'💡 提速建议',recTip1:'先升级限定卡（×3速度）',recTip2:'持续升级高级卡片',recTip3:'每天完成每日组合',recTip4:'邀请朋友获得持续佣金',recordInfoTitle:'🔴 RECORD代币',recordInfoSub:'如何赚取RECORD及其作用',recordWhat:'什么是RECORD？',recordWhatSub:'主要挖矿货币',recordWhatDesc:'RECORD是游戏主要货币，用于升级卡片和购买道具。',recordTapping:'点击圆圈',recordTappingSub:'最快的方法',recordTappingDesc:'每次点击红色圆圈获得RECORD。',recordTapPower:'升级点击力量',recordMorePerTap:'↑ RECORD/次',recordEnergyUp:'升级能量',recordMoreTaps:'↑ 更多点击',recordAutoMining:'自动挖矿',recordAutoSub:'连续24/7',recordAutoDesc:'即使离线，卡片也会自动挖掘RECORD。',recordYourSpeed:'您的速度:',recordMystery:'神秘箱',recordMysterySub:'每天免费',recordMysteryDesc:'从Tasks部分免费打开每日神秘箱。',recordEnergyRefill:'能量充值',recordEnergyRefillSub:'每天两次免费',recordEnergyRefillDesc:'当能量耗尽时，您每天可以免费充值两次。',recordHowSpend:'💡 如何使用RECORD？',recordSpend1:'🃏 升级挖矿卡片',recordSpend2:'⬆️ 升级点击力量',recordSpend3:'⚡ 扩展能量容量',recordSpend4:'⭐ 从商店购买限定卡',ppCardsUpgraded:'已升级卡片',ppRecSpeed:'REC速度',ppRecord:'RECORD',ppRecBalance:'REC余额',ppTotalTaps:'总点击',ppTasksDone:'已完成任务',ppFriends:'朋友',ppCardLevels:'卡片等级',ppTopCards:'顶级卡片',ppNoCards:'还没有升级任何卡片',mysteryTitle:'📦 神秘箱',mysterySubtitle:'每天免费——赢得RECORD或REC！',mysteryOpenBtn:'开启 🎲',mysteryAlready:'今天已开启——明天再来！',mysteryYouGot:'您获得了:'}
};
