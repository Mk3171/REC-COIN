...
if(CS){
  CS.getItem('gameData',function(err,val){
    if(!err&&val){try{var cd=JSON.parse(val);if(cd.record>=record){applyData(cd);updateUI();buildCards();buildMilestones();restoreTasksUI();}}catch(e){}}
  });
